    ...
    public static function getStaticVersions(): array
    {
        return [
            ...
            [
                ...
                'author' => 'Developer Team',
                'description' => 'Implemented central Frontpage Theme Management module (/appsupport/theme-frontpage) with database-driven theme activation, real-time live preview tab, subfolder multi-tab architecture (tabs/theme-frontpage/), standardized container-fluid & toolbar header, safe-checked Metronic dashboard header routes, modularized landing theme feature components, fixed bilingual/auth landing controls, and purged legacy website codebase.',
                'description_id' => 'Implementasi modul Manajemen Tema Halaman Depan terpusat (/appsupport/theme-frontpage) berbasis database, tab pratinjau live real-time, arsitektur multi-tab subfolder (tabs/theme-frontpage/), standardisasi container-fluid & header toolbar, proteksi route header Metronic, pemisahan modular komponen fitur landing, perbaikan tombol dwibahasa & otentikasi landing, serta pembersihan berkas kode website lama.',
                'highlights' => [
                    [
                        'type' => 'feat',
                    ...
                    [
                        'type' => 'feat',
                        'label' => 'Modular Theme & Feature Components',
                        'desc' => 'Refactored and separated landing theme feature partials (header, hero, footer, pricing, team, testimonials, how-it-works, statistics, projects) under resources/views/theme/default/features/ and layouts/partials/themes/ for dynamic customization.',
                    ],
                    [
                        'type' => 'fix',
                        'label' => 'Bilingual Button & Auth Actions',
                        'desc' => 'Fixed bilingual language switcher helper and dynamic login/dashboard buttons on public landing page theme.',
                    ],
                    [
                        'type' => 'refactor',
                        'label' => 'Legacy Website Code Cleanup',
                        'desc' => 'Purged unused legacy website controllers, models, migrations, requests, and blade views replaced by modern landing page engine.',
                    ],
                    [
                        'type' => 'ui',
                    ...
                    [
                        'type' => 'feat',
                        'label' => 'Topbar Icon Style Switcher',
                        'desc' => 'Relocated Icon Style Switcher from /appsupport/app-fiturs page header to Topbar Navbar partial (_app/icon-style.blade.php) with topbar_icon_style feature toggle integration.',
                    ],
                    [
                        'type' => 'docs',
                ...
                'commits' => [
                    [
                        ...
                        'msg' => 'docs(changelog): update v1.6.0 changelog highlights and commits',
                    ],
                    [
                        'hash' => 'ab062c6',
                        'date' => '2026-08-20 18:41',
                        'msg' => 'merapihkan dan memisahkan komponen dan feature theme untuk dinamisasi',
                    ],
                    [
                        'hash' => '6814097',
                        'date' => '2026-08-20 17:16',
                        'msg' => 'perbaikan di tombol bilingual dan auth di landing/front page',
                    ],
                    [
                        'hash' => '4b6cee5',
                        'date' => '2026-08-20 16:54',
                        'msg' => 'pembersihan file-file sampah untuk website yang di ganti dengan landing',
                    ],
                    [
                        'hash' => 'a9ac01e',
                        'date' => '2026-08-20 14:15',
                        'msg' => 'docs(help): update schema and operational guides for dynamic frontpage theme management v1.6.0',
                    ],
                    [
                        'hash' => 'af4c02b',
            ...
            [
                ...
                'badge' => 'badge-light-primary',
                'author' => 'Developer Team',
                'description' => 'Implemented global Keenicons style engine (duotone, solid, outline) across all sidebar and topbar header navigation partials, centralized icon switcher exclusively on /appsupport/app-fiturs, standardized page header cards & responsive action buttons across 6 pages, updated bilingual operational guides, and centered footer Laravel/PHP version info on mobile viewports.',
                'description_id' => 'Implementasi mesin gaya Keenicons global (duotone, solid, outline) pada seluruh partial navigasi sidebar dan topbar header, pemusatan kontrol gaya ikon secara eksklusif di /appsupport/app-fiturs, standardisasi header card halaman & tombol aksi responsif di 6 halaman, pembaruan petunjuk operasional bilingual, serta perataan tengah teks versi Laravel/PHP footer di perangkat mobile.',
                'highlights' => [
                    [
                        'type' => 'feat',
                        'label' => 'Global Keenicons Style Engine',
                        'desc' => 'Built keenicons_paths_map helper and formatIconClass() to transform all sidebar and header icons between duotone, solid, and outline styles dynamically.',
                    ],
                    [
                        'type' => 'feat',
                        'label' => 'Centralized Icon Control',
                        'desc' => 'Centralized Icon Style Switcher dropdown exclusively on /appsupport/app-fiturs header action bar with active style badges and checkmark indicators.',
                    ],
                    [
                        'type' => 'ui',
                        'label' => 'Standardized Page Header Cards',
                        'desc' => 'Standardized header cards and responsive 35px square action buttons with tooltips across 6 pages (app-fiturs, akses-role, akses-user, users, reset-password, app-profil, data-login).',
                    ],
                    [
                        'type' => 'docs',
                        'label' => 'Bilingual Guide & AGENTS Rules',
                        'desc' => 'Updated 100% bilingual operational guide modals for App Features & Menu pages and recorded Page Header standardization rules in .agents/AGENTS.md.',
                    ],
                    [
                        'type' => 'fix',
                        'label' => 'Mobile Footer Centering',
                        'desc' => 'Centered Laravel & PHP version text on mobile viewports in layout footer partial.',
                    ],
                ],
                'commits' => [
                    [
                        'hash' => '0b39d64',
                        'date' => '2026-08-20 09:17',
                        'msg' => 'feat(global): Global Keenicons Style Engine, Centralized App Features Icon Control & Standardized Responsive Page Header Cards',
                    ],
                ],
            ],
            [
