        ...
        return [
            [
                ...
                'highlights' => [
                    ...
                    ['type' => 'feat', 'label' => 'Real-Time Auto Reload & Logout', 'desc' => 'Automated page reloads after MenuSeeder/Git actions and auto-redirect to login on database reset'],
                    ...
                    ['type' => 'fix', 'label' => 'Windows Sequential Shell Execution', 'desc' => 'Replaced chained shell operators with robust sequential PHP shell execution to prevent syntax failures'],
                ],
                'commits' => [
                    ['hash' => '2b3f2dc', 'date' => '2026-08-04 00:30', 'msg' => 'feat(appsupport): otomatis reload halaman realtime & alihkan ke login saat migrate:fresh --seed selesai'],
                    ['hash' => 'b765361', 'date' => '2026-08-04 00:26', 'msg' => 'feat(appsupport): kembalikan kartu Storage Link (storage:link) dalam tata letak 5 kartu maintenance'],
                    ['hash' => 'b2b2ceb', 'date' => '2026-08-04 00:24', 'msg' => 'feat(appsupport): ganti post-clone init dengan sinkronisasi MenuSeeder & migrate:fresh --seed'],
                    ['hash' => '6762977', 'date' => '2026-08-04 00:17', 'msg' => 'refactor(appsupport): ganti tombol optimize yang mengunci route cache dengan migrasi database aman'],
                    ['hash' => 'e75a3cd', 'date' => '2026-08-04 00:08', 'msg' => 'fix(appsupport): cegah overwrite output git action & pastikan eksekusi bertahap di Windows'],
