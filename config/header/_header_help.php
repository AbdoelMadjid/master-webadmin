        ...
        [
            ...
            'children' => [
                ...
                [
                    'title' => 'Skema',
                    'children' => [
                        ['title' => 'Route', 'route' => 'help.pemrograman.skema.route'],
                        ['title' => 'Layout', 'route' => 'help.pemrograman.skema.layout'],
                        ['title' => 'Komponen Blade & Partial', 'route' => 'help.pemrograman.skema.komponen-blade-partial'],
                        ['title' => 'Theme Assets', 'route' => 'help.pemrograman.skema.theme-assets'],
                        ['title' => 'Auth dan Middleware', 'route' => 'help.pemrograman.skema.auth-dan-middleware'],
                        ['title' => 'Struktur Config Menu', 'route' => 'help.pemrograman.skema.struktur-config-menu'],
                        ['title' => 'Sidebar Menu', 'route' => 'help.pemrograman.skema.sidebar-menu'],
                        ['title' => 'Header Menu', 'route' => 'help.pemrograman.skema.header-menu'],
                        ['title' => 'Data Layer', 'route' => 'help.pemrograman.skema.data-layer'],
                        ['title' => 'Error Handling & Fallback', 'route' => 'help.pemrograman.skema.error-handling-dan-fallback'],
                        ['title' => 'Cache & Deployment', 'route' => 'help.pemrograman.skema.cache-dan-deployment'],
                        ['title' => 'Pemilihan Bahasa', 'route' => 'help.pemrograman.skema.pemilihan-bahasa'],
                        ['title' => 'i18n Lanjutan', 'route' => 'help.pemrograman.skema.i18n-lanjutan'],
                        ['title' => 'Manajemen Pengguna', 'route' => 'help.pemrograman.skema.manajemen-pengguna'],
                        ['title' => 'App Support', 'route' => 'help.pemrograman.skema.app-support'],
                        ['title' => 'Notifikasi System', 'route' => 'help.pemrograman.skema.notification'],
                        ['title' => 'SweetAlert2', 'route' => 'help.pemrograman.skema.sweetalert2'],
                    ],
                ],
                [
                    'title' => 'Operasional',
