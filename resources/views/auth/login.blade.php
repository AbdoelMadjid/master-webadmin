                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="g-mb-40">
                            ...
                            <p>{{ __('website.signin_intro_prefix') }} <a
                                    href="#">{{ __('website.signin_policies_guidelines') }}</a>.</p>
                        </div>
                        <!-- End Heading -->
                    </div>
                </div>
                ...
                <div class="row justify-content-between">
                    <div class="col-md-6 col-lg-5 order-md-2 g-pos-abs--md g-top-0 g-right-0">
                        ...
                        <form id="unify_sign_in_form" action="{{ route('login') }}" method="POST" novalidate="novalidate">
                            ...
                            @if (session('status'))
                                @php
                                    $isWarningStatus = \Illuminate\Support\Str::contains(session('status'), ['berakhir', 'keluar', 'terkeluar', '15 menit']);
                                @endphp
                            ...
                            @elseif (request()->query('reason') === 'idle')
                                <div class="alert alert-warning g-mb-20" role="alert">
                                    <i class="fa fa-exclamation-triangle mr-2"></i> Sesi Anda telah berakhir dan keluar otomatis karena tidak ada aktivitas selama 15 menit. Silakan login kembali.
                                </div>
                            @endif
                            ...
                            <div id="signin">
                                <div class="u-shadow-v35 g-bg-white rounded g-px-40 g-py-50">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a class="g-color-text-light-v1 g-font-size-default"
                                            href="{{ route('password.request') }}">{{ __('website.signin_forgot_password') }}</a>
                                        <button type="submit"
                                ...
                                <div class="text-center g-pt-30">
                                    <p class="g-color-text-light-v1 g-font-size-default mb-0">
                                        {{ __('website.signin_no_account') }} <a class="g-font-size-default"
                                            href="{{ route('register') }}">{{ __('website.signin_create_account') }}</a>
                                    </p>
                                </div>
                            </div>
                            <!-- End Signin -->
                            ...
                            <div id="signup" style="display: none;">
                                <div class="u-shadow-v35 g-bg-white rounded g-px-40 g-py-50">
                                    <div class="g-mb-20">
                                        <label
                                            class="g-color-text-light-v1 g-font-weight-500">{{ __('website.full_name') }}</label>
                                ...
                                <div class="text-center g-pt-30">
                                    <p class="g-color-text-light-v1 g-font-size-default mb-0">
                                        {{ __('website.signin_already_have_account') }} <a class="g-font-size-default"
                                            id="signin-link" href="#">{{ __('website.signin_action') }}</a></p>
                                </div>
                            </div>
                            <!-- End Signup -->
                            ...
                            <div id="forgot-password" style="display: none;">
                                ...
                                <div class="text-center g-pt-30">
                                    <p class="g-color-text-light-v1 g-font-size-default mb-0">
                                        {{ __('website.signin_remember_password') }} <a class="g-font-size-default"
                                            id="go-back-link" href="#">{{ __('website.signin_action') }}</a></p>
                                </div>
                            </div>
                            <!-- End Forgot Password -->
                        </form>
