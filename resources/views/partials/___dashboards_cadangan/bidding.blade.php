                                ...
                                <div class="col-sm-6 mb-10 mb-sm-0">
                                    ...
                                    <a class="d-block overlay h-100" data-fslightbox="lightbox-hot-sales"
                                        ...
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-200px h-100"
                                            style="background-image:url('assets/media/stock/600x600/img-42.jpg')"></div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="mb-7">
                                            <!--begin::Title-->
                                            <div class="mb-6">
                                                <span class="text-gray-500 fs-7 fw-bold me-2 d-block lh-1 pb-1">NFT ID:
                                                    34356776</span>
                ...
                <div class="col-sm-6 col-xxl-3">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-body text-center pb-5">
                            ...
                            <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                ...
                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
                                    style="height: 266px;background-image:url('assets/media/stock/600x600/img-39.jpg"></div>
                                <!--end::Image-->
                                <!--begin::Action-->
                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                    <i class="ki-duotone ki-eye fs-3x text-white">
                            ...
                            <div class="d-flex align-items-end flex-stack mb-1">
                                ...
                                <div class="text-start">
                                    <span class="fw-bold text-gray-800 cursor-pointer text-hover-primary fs-4 d-block">Wavy
                                        Curved Art</span>
                        ...
                        <div class="card-footer d-flex flex-stack pt-0">
                            ...
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a class="btn btn-sm btn-light flex-shrink-0" href="apps/ecommerce/sales/listing.html">View
                                Item</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Footer-->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="assets/media/stock/600x600/img-43.jpg" class=""
                                                            alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="assets/media/stock/600x600/img-46.jpg" class=""
                                                            alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="assets/media/stock/600x600/img-54.jpg" class=""
                                                            alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="assets/media/stock/600x600/img-45.jpg" class=""
                                                            alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
