                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Icon-->
                                    <img src="{{ URL::asset('assets/media/stock/ecommerce/14.png') }}" class="me-4 w-50px"
                                        alt="" />
                                    <!--end::Icon-->
                                    <!--begin::Section-->
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Icon-->
                                    <img src="{{ URL::asset('assets/media/stock/ecommerce/13.png') }}" class="me-4 w-50px"
                                        alt="" />
                                    <!--end::Icon-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Icon-->
                                    <img src="{{ URL::asset('assets/media/stock/ecommerce/41.png') }}" class="me-4 w-50px"
                                        alt="" />
                                    <!--end::Icon-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Icon-->
                                    <img src="{{ URL::asset('assets/media/stock/ecommerce/53.png') }}" class="me-4 w-50px"
                                        alt="" />
                                    <!--end::Icon-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Icon-->
                                    <img src="{{ URL::asset('assets/media/stock/ecommerce/71.png') }}" class="me-4 w-50px"
                                        alt="" />
                                    <!--end::Icon-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Icon-->
                                    <img src="{{ URL::asset('assets/media/stock/ecommerce/194.png') }}"
                                        class="me-4 w-50px" alt="" />
                                    <!--end::Icon-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                                        <a href="/apps/ecommerce/sales/details"
