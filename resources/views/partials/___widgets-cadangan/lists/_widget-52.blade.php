<!--begin::List widget 52-->
                    <x-widget-include-badge name="list.__widget-44" />
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-body card-body d-flex justify-content-between flex-column pt-3">
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Flag-->
                                <img src="{{ URL::asset('assets/media/svg/brand-logos/dribbble-icon-1.svg') }}"
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Flag-->
                                <img src="{{ URL::asset('assets/media/svg/brand-logos/linkedin-1.svg') }}"
                                    class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                <!--end::Flag-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Flag-->
                                <img src="{{ URL::asset('assets/media/svg/brand-logos/slack-icon.svg') }}"
                                    class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                <!--end::Flag-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Flag-->
                                <img src="{{ URL::asset('assets/media/svg/brand-logos/facebook-3.svg') }}"
                                    class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                <!--end::Flag-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
