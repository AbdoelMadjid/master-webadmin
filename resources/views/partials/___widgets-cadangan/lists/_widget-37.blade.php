                            ...
                            <div class="card card-flush h-lg-100">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <!--begin::Flag-->
                                            <img src="{{ URL::asset('assets/media/flags/brazil.svg') }}"
                                                class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                            <!--end::Flag-->
                                            <!--begin::Section-->
                                            <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <!--begin::Flag-->
                                            <img src="{{ URL::asset('assets/media/flags/turkey.svg') }}"
                                                class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                            <!--end::Flag-->
                                            <!--begin::Section-->
                                            <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <!--begin::Flag-->
                                            <img src="{{ URL::asset('assets/media/flags/france.svg') }}"
                                                class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                            <!--end::Flag-->
                                            <!--begin::Section-->
                                            <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <!--begin::Flag-->
                                            <img src="{{ URL::asset('assets/media/flags/india.svg') }}"
                                                class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                            <!--end::Flag-->
                                            <!--begin::Section-->
                                            <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <!--begin::Flag-->
                                            <img src="{{ URL::asset('assets/media/flags/sweden.svg') }}"
                                                class="me-4 w-25px" style="border-radius: 4px" alt="" />
                                            <!--end::Flag-->
                                            <!--begin::Section-->
                                            <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
