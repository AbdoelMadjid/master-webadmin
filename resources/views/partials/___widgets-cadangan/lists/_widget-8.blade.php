@php
    ...
    $headerClass = $headerClass ?? 'card-header pt-7 mb-5';
    $titleText = $titleText ?? 'Visits by Country';
    $subtitleText = $subtitleText ?? '20 countries share 97% visits';
    $toolbarHref = $toolbarHref ?? 'apps/ecommerce/sales/listing.html';
    $toolbarText = $toolbarText ?? 'View All';
    $bodyClass = $bodyClass ?? 'card-body pt-0';
...
<div class="{{ $cardClass }}">
    ...
    <div class="{{ $headerClass }}">
        ...
        <div class="card-toolbar">
            <a href="{{ $toolbarHref }}" class="btn btn-sm btn-light">{{ $toolbarText }}</a>
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
    ...
    <div class="{{ $bodyClass }}">
        ...
        <div class="m-0">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="assets/media/flags/united-states.svg" class="me-4 w-25px" style="border-radius: 4px"
                    alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
