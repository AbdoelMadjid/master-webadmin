                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Logo-->
                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/laravel-2.svg') }}"
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Logo-->
                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/vue-9.svg') }}"
                                        class="me-4 w-30px" alt="" />
                                    <!--end::Logo-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Logo-->
                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/bootstrap5.svg') }}"
                                        class="me-4 w-30px" alt="" />
                                    <!--end::Logo-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Logo-->
                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/angular-icon.svg') }}"
                                        class="me-4 w-30px" alt="" />
                                    <!--end::Logo-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Logo-->
                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/spring-3.svg') }}"
                                        class="me-4 w-30px" alt="" />
                                    <!--end::Logo-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-center me-3">
                                    <!--begin::Logo-->
                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/typescript-1.svg') }}"
                                        class="me-4 w-30px" alt="" />
                                    <!--end::Logo-->
                                    <!--begin::Section-->
                                    <div class="flex-grow-1">
