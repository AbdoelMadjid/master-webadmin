                            ...
                            <div class="">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ URL::asset('assets/media/svg/brand-logos/atica.svg') }}"
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ URL::asset('assets/media/svg/brand-logos/telegram-2.svg') }}"
                                            class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Content-->
                                        <div class="me-5">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ URL::asset('assets/media/svg/brand-logos/balloon.svg') }}"
                                            class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Content-->
                                        <div class="me-5">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ URL::asset('assets/media/svg/brand-logos/kickstarter.svg') }}"
                                            class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Content-->
                                        <div class="me-5">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ URL::asset('assets/media/svg/brand-logos/vimeo.svg') }}"
                                            class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Content-->
                                        <div class="me-5">
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center me-5">
                                        <!--begin::Flag-->
                                        <img src="{{ URL::asset('assets/media/svg/brand-logos/plurk.svg') }}"
                                            class="me-4 w-30px" style="border-radius: 4px" alt="" />
                                        <!--end::Flag-->
                                        <!--begin::Content-->
                                        <div class="me-5">
