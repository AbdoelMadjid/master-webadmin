        ...
        <div class="row align-items-end h-100 gx-5 gx-xl-10">
            ...
            <div class="col-md-4 mb-11 mb-md-0">
                ...
                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                    ...
                    <div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
                        style="height: 266px;background-image:url('assets/media/stock/900x600/42.jpg"></div>
                    <!--end::Image-->
                    <!--begin::Action-->
                ...
                <div class="m-0">
                    <!--begin::Title-->
                    <a href="#" class="text-gray-800 text-hover-primary fs-3 fw-bold d-block mb-2">Feeling
                        Good</a>
                    <!--end::Title-->
                    <!--begin::Time-->
            ...
            <div class="col-md-4 mb-11 mb-md-0">
                ...
                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                    ...
                    <!--begin::Image-->
                    <div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
                        style="height: 266px;background-image:url('assets/media/stock/900x600/40.jpg"></div>
                    <!--end::Image-->
                    <!--begin::Action-->
                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                        <i class="ki-duotone ki-eye fs-3x text-white">
            ...
            <div class="col-md-4">
                ...
                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                    ...
                    <!--begin::Image-->
                    <div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
                        style="height: 266px;background-image:url('assets/media/stock/900x600/41.jpg"></div>
                    <!--end::Image-->
                    <!--begin::Action-->
                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                        <i class="ki-duotone ki-eye fs-3x text-white">
                ...
                <div class="m-0">
                    <!--begin::Title-->
                    <a href="#" class="text-gray-800 text-hover-primary fs-3 fw-bold d-block mb-2">Birds in the
                        Sky</a>
                    <!--end::Title-->
                    <!--begin::Time-->
