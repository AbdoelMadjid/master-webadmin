                            ...
                            <div class="row align-items-end h-100 gx-5 gx-xl-10">
                                ...
                                <div class="col-md-4 mb-11 mb-md-0">
                                    ...
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        href="{{ URL::asset('assets/media/stock/900x600/42.jpg') }}">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
                                            style="height: 266px;background-image:url({{ URL::asset('assets/media/stock/900x600/42.jpg') }}">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                ...
                                <div class="col-md-4 mb-11 mb-md-0">
                                    <!--begin::Overlay-->
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        href="{{ URL::asset('assets/media/stock/900x600/40.jpg') }}">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
                                            style="height: 266px;background-image:url({{ URL::asset('assets/media/stock/900x600/40.jpg') }}">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                ...
                                <div class="col-md-4">
                                    <!--begin::Overlay-->
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        href="{{ URL::asset('assets/media/stock/900x600/41.jpg') }}">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
                                            style="height: 266px;background-image:url({{ URL::asset('assets/media/stock/900x600/41.jpg') }}">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
