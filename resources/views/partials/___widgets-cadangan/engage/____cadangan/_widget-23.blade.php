                    ...
                    <div class="card h-lg-100"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center">
                                        ...
                                        <div class="mb-7">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                                ...
                                                <div class="d-flex align-items-center me-5 me-xl-13">
                                                    ...
                                                    <!--begin::Info-->
                                                    <div class="m-0">
                                                        <a href="/pages/user-profile/projects"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <!--begin::Info-->
                                                    <div class="m-0">
                                                        <a href="/apps/user-management/users/list"
                                ...
                                <div class="col-sm-5">
                                    <!--begin::Illustration-->
                                    <img src="{{ URL::asset('assets/media/svg/illustrations/easy/7.svg') }}"
