                            ...
                            <ul class="nav nav-pills nav-pills-custom mb-3">
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4"
                                        ...
                                        <div class="nav-icon">
                                            <img alt=""
                                                src="{{ URL::asset('assets/media/svg/brand-logos/beats-electronics.svg') }}"
                                                class="" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <div class="nav-icon">
                                            <img alt="Logo"
                                                src="{{ URL::asset('assets/media/svg/brand-logos/amazon.svg') }}"
                                                class="theme-light-show" />
                                            <img alt="Logo"
                                                src="{{ URL::asset('assets/media/svg/brand-logos/amazon-dark.svg') }}"
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <div class="nav-icon">
                                            <img alt=""
                                                src="{{ URL::asset('assets/media/svg/brand-logos/bp-2.svg') }}"
                                                class="" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
                                ...
                                <li class="nav-item mb-3 me-3 me-lg-6">
                                    ...
                                    <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                                        ...
                                        <div class="nav-icon">
                                            <img alt=""
                                                src="{{ URL::asset('assets/media/svg/brand-logos/slack-icon.svg') }}"
                                                class="nav-icon" />
                                        </div>
                                        <!--end::Icon-->
                                        <!--begin::Subtitle-->
