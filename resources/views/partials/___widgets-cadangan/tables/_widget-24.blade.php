                                ...
                                <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                    ...
                                    <thead>
                                        <tr class="fs-7 fw-bold text-gray-500 border-bottom-0">
                                            ...
                                            <th class="p-0 pb-3 min-w-125px text-end">
                                                RECENT OFFER
                                            </th>
                                            <th class="p-0 pb-3 min-w-100px text-end">
                                                TIME LEFT
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ URL::asset('assets/media/stock/600x600/img-49.jpg') }}"
                                                            class="" alt="" />
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ URL::asset('assets/media/stock/600x600/img-43.jpg') }}"
                                                            class="" alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ URL::asset('assets/media/stock/600x600/img-46.jpg') }}"
                                                            class="" alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ URL::asset('assets/media/stock/600x600/img-54.jpg') }}"
                                                            class="" alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-50px me-3">
                                                        <img src="{{ URL::asset('assets/media/stock/600x600/img-45.jpg') }}"
                                                            class="" alt="" />
                                                    </div>
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="#"
