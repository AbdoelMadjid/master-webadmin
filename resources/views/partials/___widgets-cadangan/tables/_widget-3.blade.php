                        ...
                        <div class="mb-10">
                            ...
                            <div>
                                <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true"
                                    ...
                                    data-dropdown-parent="#kt_menu_65a12155119f5" data-allow-clear="true">
                                    <option></option>
                ...
                <tr>
                    <td class="min-w-175px">
                        <div class="position-relative ps-6 pe-3 py-2">
                            ...
                            <a href="#" class="mb-1 text-gray-900 text-hover-primary fw-bold">Happy
                                Christmas</a>
                ...
                <tr>
                    <td class="min-w-175px">
                        <div class="position-relative ps-6 pe-3 py-2">
                            ...
                            <a href="#" class="mb-1 text-gray-900 text-hover-primary fw-bold">Happy Mother's
                                Day</a>
                            <div class="fs-7 text-muted fw-bold">Created on 24 Dec 21</div>
                        </div>
                    </td>
