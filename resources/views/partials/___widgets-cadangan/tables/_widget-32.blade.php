<!--begin::Table widget 32-->
                    <x-widget-include-badge name="table.__widget-31" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex gap-2 mb-2">
                                                <a href="#">
                                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/facebook-4.svg') }}"
                                                        class="w-20px" alt="" />
                                                </a>
                                                <a href="#">
                                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/twitter-2.svg') }}"
                                                        class="w-20px" alt="" />
                                                </a>
                                                <a href="#">
                                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/linkedin-2.svg') }}"
                                                        class="w-20px" alt="" />
                                                </a>
                                                <a href="#">
                                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/youtube-3.svg') }}"
                                                        class="w-20px" alt="" />
                                                </a>
                                            </div>
                                            <!--end::Icons-->
                                        ...
                                        <td class="min-w-125px">
                                            ...
                                            <div class="symbol-group symbol-hover mb-1">
                                                ...
                                                <!--begin::Member-->
                                                <div class="symbol symbol-circle symbol-25px">
                                                    <img src="{{ URL::asset('assets/media/avatars/300-5.jpg') }}"
                                                        alt="" />
                                                </div>
                                                <!--end::Member-->
                                                <!--begin::Member-->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex gap-2 mb-2">
                                                ...
                                                <a href="#">
                                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/instagram-2-1.svg') }}"
                                                        class="w-20px" alt="" />
                                                </a>
                                                <a href="#">
                                                    <img src="{{ URL::asset('assets/media/svg/brand-logos/youtube-3.svg') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="min-w-125px">
                                            ...
                                            <div class="symbol-group symbol-hover mb-1">
                                                ...
                                                <!--begin::Member-->
                                                <div class="symbol symbol-circle symbol-25px">
                                                    <img src="{{ URL::asset('assets/media/avatars/300-13.jpg') }}"
                                                        alt="" />
                                                </div>
                                                <!--end::Member-->
                                            </div>
