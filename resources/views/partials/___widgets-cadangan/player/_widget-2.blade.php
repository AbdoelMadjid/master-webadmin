                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url({{ URL::asset('assets/media/stock/600x600/img-61.jpg') }});
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url({{ URL::asset('assets/media/stock/600x600/img-60.jpg') }});
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url({{ URL::asset('assets/media/stock/600x600/img-63.jpg') }});
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url({{ URL::asset('assets/media/stock/600x600/img-56.jpg') }});
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url({{ URL::asset('assets/media/stock/600x600/img-57.jpg') }});
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url({{ URL::asset('assets/media/stock/600x600/img-58.jpg') }});
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                ...
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url({{ URL::asset('assets/media/stock/600x600/img-55.jpg') }});
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="card-rounded position-relative mb-5">
                                            ...
                                            <div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
                                                style="
                                      background-image: url({{ URL::asset('assets/media/stock/600x600/img-64.jpg') }});
                                    ">
                                            </div>
                                            <!--end::Img-->
                                            <!--begin::Play-->
