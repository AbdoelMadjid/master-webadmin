...
@section('content')
    <!-- Carousel Slider -->
    @include('website.templates.unify-education.content.carousel-slider')
    <!-- End Carousel Slider -->

    <!-- Find a Course -->
    @include('website.templates.unify-education.content.find-a-cource')
    <!-- End Find a Course -->

    <!-- Learn First Steps -->
    @include('website.templates.unify-education.content.learn-first-steps')
