...
@section('title', __('website.meta_title_research'))
@section('css')
    ...
    <div class="g-bg-img-hero" style="background-image: url(assets/include/svg/svg-bg1.svg);">
        <div class="container g-py-100">
            <div class="row justify-content-lg-between align-items-center">
                ...
                <div class="col-md-5">
                    <div class="mb-4">
                        <h1 class="mb-3">{{ __('website.research_hero_title') }}</h1>
                        <p>{{ __('website.research_hero_desc') }}</p>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-9 g-mb-50">
                <div class="d-flex justify-content-lg-between align-items-lg-center g-mb-30">
                    <h2>{{ __('website.research_publications') }}</h2>
                    <a class="u-link-v5 g-color-primary g-color-main--hover" href="#">{{ __('website.research_see_all_publications') }}
                ...
                <div class="row">
                    <div class="col-6 col-md-4 g-mb-40">
                        ...
                        <article>
                            ...
                            <h3 class="h4 mb-3"><a class="h4 u-link-v5" href="#">{{ __('website.research_article_1_title') }}</a></h3>
                            <p class="g-color-text-light-v1 g-font-size-15">{{ __('website.research_article_1_desc') }}</p>
                            <a class="g-font-size-default" href="#">{{ __('website.read_more') }} <i
                    ...
                    <div class="col-6 col-md-4 g-mb-40">
                        ...
                        <article>
                            ...
                            <h3 class="h4 mb-3"><a class="h4 u-link-v5" href="#">{{ __('website.research_article_2_title') }}</a></h3>
                            <p class="g-color-text-light-v1 g-font-size-15">{{ __('website.research_article_2_desc') }}</p>
                            <a class="g-font-size-default" href="#">{{ __('website.read_more') }} <i
                                    class="g-font-size-13 g-pos-rel g-top-3 material-icons">arrow_forward</i></a>
                        </article>
                        <!-- End Research Article -->
                    ...
                    <div class="col-6 col-md-4 g-mb-40">
                        ...
                        <article>
                            ...
                            <h3 class="h4 mb-3"><a class="h4 u-link-v5" href="#">{{ __('website.research_article_3_title') }}</a></h3>
                            <p class="g-color-text-light-v1 g-font-size-15">{{ __('website.research_article_3_desc') }}</p>
                            <a class="g-font-size-default" href="#">{{ __('website.read_more') }} <i
                                    class="g-font-size-13 g-pos-rel g-top-3 material-icons">arrow_forward</i></a>
                        </article>
                        <!-- End Research Article -->
                    ...
                    <div class="col-6 col-md-4 g-mb-40">
                        ...
                        <article>
                            ...
                            <h3 class="h4 mb-3"><a class="h4 u-link-v5" href="#">{{ __('website.research_article_4_title') }}</a></h3>
                            <p class="g-color-text-light-v1 g-font-size-15">{{ __('website.research_article_4_desc') }}</p>
                            <a class="g-font-size-default" href="#">{{ __('website.read_more') }} <i
                                    class="g-font-size-13 g-pos-rel g-top-3 material-icons">arrow_forward</i></a>
                        </article>
                        <!-- End Research Article -->
                    ...
                    <div class="col-6 col-md-4 g-mb-40">
                        ...
                        <article>
                            ...
                            <h3 class="h4 mb-3"><a class="h4 u-link-v5" href="#">{{ __('website.research_article_5_title') }}</a></h3>
                            <p class="g-color-text-light-v1 g-font-size-15">{{ __('website.research_article_5_desc') }}</p>
                            <a class="g-font-size-default" href="#">{{ __('website.read_more') }} <i
                                    class="g-font-size-13 g-pos-rel g-top-3 material-icons">arrow_forward</i></a>
                        </article>
                        <!-- End Research Article -->
                    ...
                    <div class="col-6 col-md-4 g-mb-40">
                        ...
                        <article>
                            ...
                            <h3 class="h4 mb-3"><a class="h4 u-link-v5" href="#">{{ __('website.research_article_6_title') }}</a></h3>
                            <p class="g-color-text-light-v1 g-font-size-15">{{ __('website.research_article_6_desc') }}</p>
                            <a class="g-font-size-default" href="#">{{ __('website.read_more') }} <i
                                    class="g-font-size-13 g-pos-rel g-top-3 material-icons">arrow_forward</i></a>
                        </article>
                        <!-- End Research Article -->
                ...
                <div class="u-shadow-v36 g-bg-main-light-v2 g-pa-30">
                    <ul class="list-unstyled mb-0">
                        <li class="g-brd-bottom g-brd-white-opacity-0_1 g-pb-20">
                            <h3 class="g-color-white g-font-primary mb-0">{{ __('website.research_facts_title') }}</h3>
                        </li>
                        <li class="g-brd-bottom g-brd-white-opacity-0_1 g-py-20">
                            <h3 class="g-color-white g-font-primary mb-0">{{ __('website.home_top_25') }}</h3>
                            <p class="g-color-white-opacity-0_8 g-font-size-default mb-0">{{ __('website.research_fact_top_25_desc') }}</p>
                        </li>
                        <li class="g-brd-bottom g-brd-white-opacity-0_1 g-py-20">
                            <h3 class="g-color-white g-font-primary mb-0">100%</h3>
                            <p class="g-color-white-opacity-0_8 g-font-size-default mb-0">{{ __('website.research_fact_100_desc') }}</p>
                        </li>
                        <li class="g-brd-bottom g-brd-white-opacity-0_1 g-py-20">
                            <h3 class="g-color-white g-font-primary mb-0">70+</h3>
                            <p class="g-color-white-opacity-0_8 g-font-size-default mb-0">{{ __('website.research_fact_70_desc') }}</p>
                        </li>
                        <li class="g-pt-20">
                            <h3 class="g-color-white g-font-primary mb-0">{{ __('website.home_tripling') }}</h3>
                            <p class="g-color-white-opacity-0_8 g-font-size-default mb-0">{{ __('website.research_fact_tripling_desc') }}</p>
                        </li>
                    </ul>
                </div>
                <!-- End Facts List -->
    ...
    <div class="g-bg-main-light-v2">
        <div class="container g-pt-100 g-pb-80">
            ...
            <div class="g-max-width-645 text-center mx-auto g-mb-60">
                <h2 class="h1 g-color-white mb-3">{{ __('website.research_articles_title') }}</h2>
                <p class="g-color-white-opacity-0_8">{{ __('website.cta_strategy_text') }}</p>
            </div>
            <!-- End Heading -->
            ...
            <div class="card-group d-block d-md-flex g-mx-minus-15">
                    ...
                    <article>
                        <div class="g-pos-rel">
                            ...
                            <a class="js-fancybox g-absolute-centered" href="javascript:;"
                                data-src="//www.youtube.com/watch?v=FxiskmF16gU" data-speed="350" data-caption="{{ __('website.campus_video') }}">
                                <span
                        ...
                        <div class="card-body g-bg-white text-center g-pa-20">
                            <h3 class="h4 mb-0">{{ __('website.research_featured_1') }}</h3>
                        </div>
                    </article>
                    <!-- End Research Article -->
                </div>
                ...
                <div class="card u-shadow-v36 g-brd-none g-mx-15 g-mb-30">
                    ...
                    <article>
                        ...
                        <div class="card-body g-bg-white text-center g-pa-20">
                            <h3 class="h4 mb-0">{{ __('website.research_featured_2') }}</h3>
                        </div>
                    </article>
                    <!-- End Research Article -->
                </div>
                ...
                <div class="card u-shadow-v36 g-brd-none g-mx-15 g-mb-30">
                    ...
                    <article>
                        ...
                        <div class="card-body g-bg-white text-center g-pa-20">
                            <h3 class="h4 mb-0">{{ __('website.research_featured_3') }}</h3>
                        </div>
                    </article>
                    <!-- End Research Article -->
                </div>
        ...
        <div class="row">
                ...
                <article
                    ...
                    <div class="u-block-hover__additional--partially-slide-up g-pos-abs g-bottom-0 g-left-0 g-z-index-1">
                        <div class="u-block-hover__visible g-pa-20">
                            <h3 class="h4 g-color-white mb-0">{{ __('website.campus_recognition_article_1') }}</h3>
                        </div>
            ...
            <div class="col-sm-6 col-lg-3 g-mb-30">
                ...
                <article>
                    ...
                    <span
                        class="d-block g-color-secondary-light-v1 g-font-weight-500 g-font-size-12 text-uppercase mb-2">{{ __('website.campus_video') }}</span>
                    <h4 class="h5">
                        <a class="js-fancybox h5 u-link-v5" href="javascript:;"
                            data-src="//www.youtube.com/watch?v=FxiskmF16gU" data-speed="350"
                            data-caption="{{ __('website.campus_video') }}">{{ __('website.campus_recognition_article_2') }}</a>
                    </h4>
                </article>
                <!-- End Research Articles -->
            </div>
            ...
            <div class="col-sm-6 col-lg-3 g-mb-30">
                ...
                <article>
                    ...
                    <h4 class="h5">
                        <a class="js-fancybox h5 u-link-v5" href="javascript:;"
                            data-src="//www.youtube.com/watch?v=FxiskmF16gU" data-speed="350" data-caption="{{ __('website.campus_video') }}">{{ __('website.campus_recognition_article_3') }}</a>
                    </h4>
                </article>
                <!-- End Research Articles -->
            </div>
            ...
            <div class="col-sm-6 col-lg-3 g-mb-30">
                ...
                <article
                    ...
                    <div class="u-block-hover__additional--partially-slide-up g-pos-abs g-bottom-0 g-left-0 g-z-index-1">
                        <div class="u-block-hover__visible g-pa-20">
                            <h3 class="h4 g-color-white mb-0">{{ __('website.campus_recognition_article_4') }}</h3>
                        </div>
                        <div class="g-pa-5"></div>
                    </div>
                    <a class="u-link-v2 g-z-index-2" href="#"></a>
