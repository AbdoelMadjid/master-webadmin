                                ...
                                @forelse(($topUsers ?? []) as $rank => $user)
                                    <tr>
                                        ...
                                        <td class="text-end pe-4">
                                            <a href="{{ url('manajemenpengguna/users?search=' . urlencode($user->name)) }}" class="btn btn-sm btn-icon btn-light-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat Detail User">
