                    ...
                    <div class="d-flex flex-column gap-6">
                        ...
                        <div class="card schema-card bg-light-secondary border border-gray-300 p-6 rounded">
                            ...
                            <ul class="text-gray-700 fs-6 mb-0 ps-5">
                                <li class="mb-2">
                                    <strong>Website Identity & Logo:</strong> Manage main brand logo, mini mobile logo, website name (ID & EN), and established year.
                                </li>
                                <li class="mb-2">
                                ...
                                <li class="mb-2">
                                    <strong>Website Template Selection:</strong> Select and switch the active layout template (default standard: <em>Unify Education</em>). Future templates automatically bind to site data.
                                </li>
                                <li>
                        ...
                        <div class="card schema-card bg-light-info border border-info p-6 rounded">
                            ...
                            <ol class="text-gray-700 fs-6 mb-0 ps-5">
                                <li class="mb-2">
                                    <strong>Updating Logo & Name:</strong> Go to <span class="badge badge-primary">Website Identity & Logo</span> tab, upload PNG/SVG logo files, enter the website name, and specify the established year.
                                </li>
                                <li class="mb-2">
                ...
                @else
                    ...
                    <div class="d-flex flex-column gap-6">
                        ...
                        <div class="card schema-card bg-light-secondary border border-gray-300 p-6 rounded">
                            ...
                            <ul class="text-gray-700 fs-6 mb-0 ps-5">
                                <li class="mb-2">
                                    <strong>Identitas & Logo Website:</strong> Mengatur logo utama brand, logo mini mobile, nama website (ID & EN), serta tahun berdiri.
                                </li>
                                <li class="mb-2">
                                ...
                                <li class="mb-2">
                                    <strong>Pilihan Template Website:</strong> Memilih dan mengatur template tampilan aktif (standar terpilih bawaan: <em>Unify Education</em>). Template baru di masa depan akan otomatis terhubung dengan data website.
                                </li>
                                <li>
                        ...
                        <div class="card schema-card bg-light-info border border-info p-6 rounded">
                            ...
                            <ol class="text-gray-700 fs-6 mb-0 ps-5">
                                <li class="mb-2">
                                    <strong>Mengubah Logo & Nama:</strong> Buka tab <span class="badge badge-primary">Identitas & Logo Website</span>, upload file logo PNG/SVG, isikan nama website dan tahun berdiri.
                                </li>
                                <li class="mb-2">
                        ...
                        <div class="card schema-card bg-light-warning border border-warning p-6 rounded">
                            ...
                            <ul class="text-gray-700 fs-6 mb-0 ps-5">
                                ...
                                <li>
                                    <strong>Integritas Fallback:</strong> Jika belum ada logo custom yang di-upload, sistem otomatis menggunakan logo bawaan.
                                </li>
                            </ul>
                        </div>
                    </div>
