            ...
            <div class="card-header border-0 pt-6">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-gray-900 fs-5 d-flex align-items-center">
                        <i class="ki-duotone ki-file-up fs-2 text-info me-2"><span class="path1"></span><span class="path2"></span></i>
                        Konversi Berkas .html → .blade.php
                    </span>
                    <span class="text-muted mt-1 fw-semibold fs-7">
                        Rename massal seluruh file berkestensi <code>.html</code> menjadi <code>.blade.php</code> secara rekursif.
                    </span>
                </h3>
            </div>
            <div class="card-body pt-2 d-flex flex-column justify-content-between">
                <form id="kt_form_html_to_blade" onsubmit="submitFileUtility(event, 'html_to_blade')">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control form-control-solid" name="target_path" value="resources/views" required />
                        <div class="form-text fs-8">Path relatif dari root project (contoh: <code>resources/views</code> atau <code>resources/views/pages</code>).</div>
                    </div>
    ...
    <div class="col-md-6">
        <div class="card shadow-xs h-100">
            <div class="card-header border-0 pt-6">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-gray-900 fs-5 d-flex align-items-center">
                        <i class="ki-duotone ki-text-number fs-2 text-primary me-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span><span class="path6"></span></i>
            ...
            <div class="card-body pt-2">
                <form id="kt_form_prefix_utility" onsubmit="submitFileUtilityPrefix(event)">
                    <div class="mb-3">
                        ...
                        <select class="form-select form-select-solid" name="utility_type" id="prefix_utility_type" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-solid" name="prefix" placeholder="Contoh: _ atau promo-" required />
                    </div>
