    ...
    <div class="col-xl-6">
        <div class="card card-flush h-lg-100 border border-primary border-dashed">
            ...
            <div class="card-body pt-2">
                <div class="alert alert-dismissible bg-light-primary border border-primary border-dashed d-flex flex-column flex-sm-row p-5 mb-7">
                ...
                <form class="form" onsubmit="event.preventDefault(); return false;">
                    ...
                    <div class="mb-6">
                        <label class="form-label fw-bold text-gray-800 fs-6">
                            <i class="ki-duotone ki-user text-primary me-1"><span class="path1"></span><span class="path2"></span></i>
                            {{ app()->getLocale() == 'en' ? 'Gender (JENKEL)' : 'Jenis Kelamin (JENKEL)' }}
                        </label>
                        <select class="form-select form-select-solid" id="demo_jenkel">
                            <option value="">{{ app()->getLocale() == 'en' ? '-- Select Gender --' : '-- Pilih Jenis Kelamin --' }}</option>
                            @if (isset($previewData['JENKEL']))
                                @foreach ($previewData['JENKEL']->activeItems as $item)
                                    <option value="{{ $item->kode }}">{{ $item->nama }} ({{ $item->kode }})</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
                    ...
                    <div class="mb-6">
                        <label class="form-label fw-bold text-gray-800 fs-6">
                            <i class="ki-duotone ki-abstract-26 text-info me-1"><span class="path1"></span><span class="path2"></span></i>
                            {{ app()->getLocale() == 'en' ? 'Religion (AGAMA)' : 'Agama & Kepercayaan (AGAMA)' }}
                        </label>
                        <select class="form-select form-select-solid" id="demo_agama">
                            <option value="">{{ app()->getLocale() == 'en' ? '-- Select Religion --' : '-- Pilih Agama --' }}</option>
                    ...
                    <div class="mb-6">
                        <label class="form-label fw-bold text-gray-800 fs-6">
                            <i class="ki-duotone ki-heart text-danger me-1"><span class="path1"></span><span class="path2"></span></i>
                        ...
                        <select class="form-select form-select-solid" id="demo_status_perkawinan">
                            <option value="">{{ app()->getLocale() == 'en' ? '-- Select Marital Status --' : '-- Pilih Status Perkawinan --' }}</option>
                    ...
                    <div class="mb-6">
                        <label class="form-label fw-bold text-gray-800 fs-6">
                            <i class="ki-duotone ki-teacher text-success me-1"><span class="path1"></span><span class="path2"></span></i>
                        ...
                        <select class="form-select form-select-solid" id="demo_pendidikan">
                            <option value="">{{ app()->getLocale() == 'en' ? '-- Select Education --' : '-- Pilih Tingkat Pendidikan --' }}</option>
                    ...
                    <div class="mb-6">
                        <label class="form-label fw-bold text-gray-800 fs-6">
                            <i class="ki-duotone ki-drop text-danger me-1"><span class="path1"></span><span class="path2"></span></i>
                            ...
                            @if (isset($previewData['GOLONGAN_DARAH']))
                                @foreach ($previewData['GOLONGAN_DARAH']->activeItems as $item)
                                    <label class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" type="radio" name="demo_golongan_darah" value="{{ $item->kode }}" />
                                        <span class="form-check-label fw-semibold text-gray-800">{{ $item->nama }}</span>
                                    </label>
                                @endforeach
                            @endif
                        </div>
            ...
            <div class="card-body pt-2">
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-dark p-4 rounded text-white font-monospace fs-7 overflow-auto">
                        ...
                        <span class="text-warning">$jenkelCategory</span> = ReferensiKategori::<span class="text-info">with</span>(<span class="text-danger">'activeItems'</span>)<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;-><span class="text-info">where</span>(<span class="text-danger">'kode'</span>, <span class="text-danger">'JENKEL'</span>)<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;-><span class="text-info">first</span>();<br/>
                        <span class="text-warning">$jenkelItems</span> = <span class="text-warning">$jenkelCategory</span> ? <span class="text-warning">$jenkelCategory</span>->activeItems : [];
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-dark p-4 rounded text-white font-monospace fs-7 overflow-auto">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;{ <span class="text-info">"kode"</span>: <span class="text-danger">"L"</span>, <span class="text-info">"nama"</span>: <span class="text-danger">"Laki-Laki"</span> },<br/>
                        &nbsp;&nbsp;&nbsp;&nbsp;{ <span class="text-info">"kode"</span>: <span class="text-danger">"P"</span>, <span class="text-info">"nama"</span>: <span class="text-danger">"Perempuan"</span> }<br/>
                        &nbsp;&nbsp;]<br/>
                        }
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="bg-dark p-4 rounded text-white font-monospace fs-7 overflow-auto">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&lt;option value="&#123;&#123; $item->kode &#125;&#125;"&gt;&#123;&#123; $item->nama &#125;&#125;&lt;/option&gt;<br/>
