    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form id="kt_form_referensi_item" class="form" action="{{ route('appsupport.referensi.item.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row mb-8">
                        <div class="col-md-7 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid text-uppercase" placeholder="e.g. L, P, ISLAM" name="kode" id="item_kode" required />
                        </div>
                        <div class="col-md-5 fv-row">
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                <span>{{ app()->getLocale() == 'en' ? 'Display Order' : 'Urutan Tampil' }}</span>
                            </label>
                            <input type="number" class="form-control form-control-solid" min="0" placeholder="1" name="urutan" id="item_urutan" value="1" />
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <input type="text" class="form-control form-control-solid" placeholder="e.g. Laki-Laki, Kristen Protestan" name="nama" id="item_nama" required />
                    </div>
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <textarea class="form-control form-control-solid" rows="2" name="keterangan" id="item_keterangan" placeholder="{{ app()->getLocale() == 'en' ? 'Optional extra details or internal code mapping' : 'Catatan opsional atau info tambahan' }}"></textarea>
                    </div>
                    ...
                    <div class="d-flex flex-stack mb-8">
                        <div class="me-5">
                            ...
                            <div class="fs-7 text-muted">{{ app()->getLocale() == 'en' ? 'Active items will be loaded in dropdown forms' : 'Item aktif akan dapat dipilih dalam form dropdown' }}</div>
                        </div>
                    ...
                    <div class="text-center">
                        ...
                        <button type="submit" class="btn btn-primary" id="btn_submit_item">
                            <span class="indicator-label">{{ app()->getLocale() == 'en' ? 'Save Item' : 'Simpan Item' }}</span>
