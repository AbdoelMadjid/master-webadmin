...
<form id="kt_form_app_profil" class="form" enctype="multipart/form-data"
    action="{{ isset($appProfil) && $appProfil->id ? route('app-profil.update', $appProfil->id) : route('app-profil.store') }}"
    method="POST">
    @csrf
    ...
    <div class="row g-9 mb-8">
        ...
        <div class="col-md-6 fv-row">
            ...
            <input type="text" class="form-control form-control-solid" placeholder="Contoh: Master WebAdmin"
                name="nama_aplikasi" id="input_nama_aplikasi"
                value="{{ old('nama_aplikasi', $appProfil->nama_aplikasi ?? '') }}" required />
        </div>
        ...
        <div class="col-md-6 fv-row">
            ...
            <input type="text" class="form-control form-control-solid" placeholder="Contoh: MWA"
                ...
                value="{{ old('singkatan_aplikasi', $appProfil->singkatan_aplikasi ?? '') }}" />
        </div>
    </div>
    ...
    <div class="row g-9 mb-8">
        ...
        <div class="col-md-6 fv-row">
            ...
            <input type="text" class="form-control form-control-solid" placeholder="Contoh: 2026" name="tahun"
                id="input_tahun" value="{{ old('tahun', $appProfil->tahun ?? '') }}" required />
        </div>
    </div>
    ...
    <div class="row g-9 mb-8">
        ...
        <div class="col-md-4 fv-row">
            ...
            <input type="file" class="form-control form-control-solid image-input-file" name="logo"
                id="input_logo" accept="image/*" data-preview="#logo_preview_img"
            ...
            <div id="logo_preview_container" class="mt-3 {{ !empty($appProfil?->logo_url) ? '' : 'd-none' }}">
                ...
                <div class="symbol symbol-100px bg-light p-2 rounded border">
                    <img id="logo_preview_img" src="{{ $appProfil?->logo_url ?? '' }}" alt="Logo Utama Preview"
                        class="object-fit-contain mw-100 mh-100" />
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 fv-row">
            ...
            <input type="file" class="form-control form-control-solid image-input-file" name="logo_small"
                id="input_logo_small" accept="image/*" data-preview="#logo_small_preview_img"
                data-container="#logo_small_preview_container" />
            <div class="form-text">Posisi sidebar ciut (Minimized). Maks. 2MB</div>

            <div id="logo_small_preview_container"
                class="mt-3 {{ !empty($appProfil?->logo_small_url) ? '' : 'd-none' }}">
                ...
                <div class="symbol symbol-50px symbol-circle bg-light p-2 rounded border">
                    <img id="logo_small_preview_img" src="{{ $appProfil?->logo_small_url ?? '' }}"
                        alt="Logo Small Preview" class="object-fit-contain mw-100 mh-100" />
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 fv-row">
            ...
            <input type="file" class="form-control form-control-solid image-input-file" name="favicon"
                id="input_favicon" accept="image/*,.ico" data-preview="#favicon_preview_img"
            ...
            <div id="favicon_preview_container" class="mt-3 {{ !empty($appProfil?->favicon_url) ? '' : 'd-none' }}">
                ...
                <div class="symbol symbol-35px bg-light p-2 rounded border">
                    <img id="favicon_preview_img" src="{{ $appProfil?->favicon_url ?? '' }}" alt="Favicon Preview"
                        class="object-fit-contain mw-100 mh-100" />
                </div>
            </div>
        </div>
