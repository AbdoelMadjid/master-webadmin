        ...
        <div class="modal-content bg-dark text-white rounded">
            <div class="modal-header border-bottom border-gray-800 py-3 px-6 justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                    <i class="ki-duotone ki-cross fs-1 text-gray-400"><span class="path1"></span><span class="path2"></span></i>
                </button>
            </div>
            ...
            <div class="modal-body p-6">
                ...
                <div class="bg-black p-4 rounded border border-gray-800 shadow-inner font-monospace" style="max-height: 450px; overflow-y: auto;">
...
function copyConsoleOutput() {
    ...
    navigator.clipboard.writeText(text).then(function() {
        if (typeof SwalHelper !== 'undefined') {
            SwalHelper.success("{{ app()->getLocale() == 'en' ? 'Console output copied to clipboard' : 'Log eksekusi berhasil disalin' }}");
        }
    });
}
</script>
