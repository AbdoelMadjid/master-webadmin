                    ...
                    <div class="d-flex flex-column gap-6">
                        ...
                        <div class="card schema-card bg-light-info border border-info p-6 rounded">
                            ...
                            <ol class="fs-6 text-gray-700 m-0 ps-5">
                                <li class="mb-2"><strong>Add Single Menu:</strong> Click the <span class="badge badge-light-primary text-primary">+ Add Menu</span> button, fill in the menu details (Name, Route/URL, Category, Parent, Icon), and save to update database and sidebar.</li>
                                <li class="mb-2"><strong>Batch Menu Creator (Tambah Partai):</strong> Click <span class="badge badge-light-success text-success">+ Batch Menu</span> to build an entire menu structure (Main Menu -> Sub-Menus -> Sub-Sub-Menus) dynamically in a single transaction.</li>
                                <li class="mb-2"><strong>Real-time Auto-slugging & Auto-translation:</strong> As you type the Indonesian menu name, the system automatically generates hierarchical Route/URLs (e.g. <code>manajemensekolah/datakeahlian/bidang-keahlian</code>), translation keys (e.g. <code>wd_bidang-keahlian</code>), and translates the English name (e.g. <code>School Management</code>) in real-time.</li>
                                <li class="mb-2"><strong>Edit & Delete Menu:</strong> Use the action buttons (<i class="ki-duotone ki-pencil fs-6 text-primary"><span class="path1"></span><span class="path2"></span></i> or <i class="ki-duotone ki-trash fs-6 text-danger"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>) on each row to modify attributes or remove menu items. Deleting a Main Menu (Level 0) or Sub-Menu (Level 1) automatically deletes all nested child menus underneath.</li>
                        ...
                        <div class="card schema-card bg-light-warning border border-warning p-6 rounded">
                            ...
                            <ul class="fs-6 text-gray-700 m-0 ps-5">
                                <li class="mb-2"><strong>Automatic Bilingual Translation:</strong> The system automatically translates Indonesian menu names to English using built-in dictionaries and background translation services, while preserving any custom manual edits.</li>
                                <li class="mb-2"><strong>Hierarchical Route Auto-Slugging:</strong> Nested sub-menus automatically inherit and append their parent route paths (Level 0 &rarr; Level 1 &rarr; Level 2).</li>
                                <li class="mb-2"><strong>Recursive Cascade Deletion:</strong> Deleting a parent menu (Level 0 or Level 1) automatically deletes all nested child sub-menus (Level 1 & Level 2) recursively from the database.</li>
                                <li class="mb-2"><strong>Bilingual Key Cleanup:</strong> Deleting menu items automatically removes their corresponding translation entries (<code>title_key</code>) from both <code>lang/id/menu.php</code> and <code>lang/en/menu.php</code>.</li>
                ...
                @else
                    ...
                    <div class="d-flex flex-column gap-6">
                        ...
                        <div class="card schema-card bg-light-info border border-info p-6 rounded">
                            ...
                            <ol class="fs-6 text-gray-700 m-0 ps-5">
                                <li class="mb-2"><strong>Tambah Menu Tunggal:</strong> Klik tombol <span class="badge badge-light-primary text-primary">+ Tambah Menu</span>, lengkapi atribut menu (Nama, Route/URL, Kategori, Induk, Ikon), dan simpan untuk memperbarui basis data dan sidebar.</li>
                                <li class="mb-2"><strong>Tambah Partai Menu (Batch Creator):</strong> Klik <span class="badge badge-light-success text-success">+ Tambah Partai Menu</span> untuk menyusun seluruh pohon menu (Menu Utama -> Sub-Menu -> Sub-Sub-Menu) secara dinamis dalam satu kali simpan.</li>
                                <li class="mb-2"><strong>Otomatisasi Route & Penerjemah Real-Time:</strong> Saat mengetik Nama Menu (ID), sistem secara otomatis membuat Route/URL bertingkat (contoh: <code>manajemensekolah/datakeahlian/bidang-keahlian</code>), kunci translasi (contoh: <code>wd_bidang-keahlian</code>), dan menerjemahkan nama Bahasa Inggris (contoh: <code>School Management</code>).</li>
                                <li class="mb-2"><strong>Edit & Hapus Menu:</strong> Gunakan tombol aksi (<i class="ki-duotone ki-pencil fs-6 text-primary"><span class="path1"></span><span class="path2"></span></i> atau <i class="ki-duotone ki-trash fs-6 text-danger"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i>) pada setiap baris tabel untuk mengubah atribut atau menghapus menu. Jika menu utama (Level 0) atau sub-menu (Level 1) dihapus, maka seluruh anak menu di dalamnya akan otomatis terhapus.</li>
                        ...
                        <div class="card schema-card bg-light-warning border border-warning p-6 rounded">
                            ...
                            <ul class="fs-6 text-gray-700 m-0 ps-5">
                                <li class="mb-2"><strong>Penerjemah Otomatis Bahasa Inggris:</strong> Sistem otomatis menerjemahkan nama menu Bahasa Indonesia ke Bahasa Inggris menggunakan kamus internal dan layanan online, dengan tetap mempertahankan kustomisasi manual pengguna.</li>
                                <li class="mb-2"><strong>Otomatisasi Route Bertingkat:</strong> Sub-menu turunan otomatis mengambil dan menggabungkan prefix path induknya (Level 0 &rarr; Level 1 &rarr; Level 2).</li>
                                <li class="mb-2"><strong>Penghapusan Kaskade Rekursif:</strong> Menghapus menu induk (Level 0 atau Level 1) secara otomatis menghapus seluruh turunan sub-menu di dalamnya (Level 1 & Level 2) secara rekursif dari database.</li>
                                <li class="mb-2"><strong>Pembersihan Kunci Translasi:</strong> Penghapusan menu secara otomatis membersihkan entri translasi bilingual (<code>title_key</code>) dari <code>lang/id/menu.php</code> dan <code>lang/en/menu.php</code>.</li>
