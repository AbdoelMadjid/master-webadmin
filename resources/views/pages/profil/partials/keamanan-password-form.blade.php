<div class="card h-100 mb-5 mb-xl-10">
    ...
    <div id="kt_account_signin_method" class="collapse show">
        <div class="card-body border-top p-9">
            <form id="form_profil_keamanan_password" action="{{ route('profil-pengguna.keamanan.password.update') }}"
                ...
                <div class="mb-6 fv-row">
                    ...
                    <div class="input-group input-group-solid input-group-lg">
                        ...
                        <span class="input-group-text cursor-pointer btn-toggle-password"
                            data-target="input_current_password" data-bs-toggle="tooltip" data-bs-placement="top"
                ...
                <div class="mb-6 fv-row">
                    ...
                    <div class="input-group input-group-solid input-group-lg mb-3">
                        <input type="password" name="password" id="input_new_password"
                            class="form-control form-control-lg form-control-solid" placeholder="Minimal 9 karakter"
                            required />
                        <span class="input-group-text cursor-pointer btn-toggle-password"
                            data-target="input_new_password" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Tampilkan / Sembunyikan Password">
                            <i class="ki-duotone ki-eye fs-2 toggle-icon"><span class="path1"></span><span
                                    class="path2"></span><span class="path3"></span></i>
                        </span>
                    ...
                    <div id="passwordRequirementsCard" class="card bg-light p-4 mb-3 rounded fs-7 border border-dashed">
                        ...
                        <div class="d-flex align-items-center mb-2" id="req-length">
                            <i class="ki-duotone ki-cross-circle text-gray-400 me-2 fs-6 req-icon"><span
                ...
                <div class="mb-6 fv-row">
                    ...
                    <div class="input-group input-group-solid input-group-lg mb-3">
                        <input type="password" name="password_confirmation" id="input_confirm_password"
                            class="form-control form-control-lg form-control-solid" placeholder="Ulangi password baru"
                            required />
                        <span class="input-group-text cursor-pointer btn-toggle-password"
                            data-target="input_confirm_password" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Tampilkan / Sembunyikan Password">
                            <i class="ki-duotone ki-eye fs-2 toggle-icon"><span class="path1"></span><span
                                    class="path2"></span><span class="path3"></span></i>
                        </span>
                ...
                <div class="d-flex justify-content-end pt-4">
                    ...
                    <button type="submit" class="btn btn-primary" id="btn_simpan_password">
                        <span class="indicator-label"><i class="ki-duotone ki-check fs-2 me-1"></i> Perbarui
                            Password</span>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        formPassword.addEventListener('reset', function() {
            setTimeout(function() {
                [currentPasswordInput, newPasswordInput, confirmPasswordInput].forEach(function(
                    input) {
                    if (input) input.type = 'password';
                });
                document.querySelectorAll('.btn-toggle-password .toggle-icon').forEach(function(
                    icon) {
                    icon.classList.remove('ki-eye-slash', 'text-primary');
                    icon.classList.add('ki-eye');
                });
        ...
        formPassword.addEventListener('submit', function(e) {
            ...
            if (!isReqMet) {
                if (typeof SwalHelper !== 'undefined' && SwalHelper.error) {
                    ...
                    Swal.fire({
                        text: 'Password baru belum memenuhi seluruh syarat kriteria keamanan.',
                        icon: 'error',
