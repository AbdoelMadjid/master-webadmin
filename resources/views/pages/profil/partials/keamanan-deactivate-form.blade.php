        ...
        <div class="card-body border-top p-9">
            @if ($isDeactivatePending)
                ...
                <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                    <i class="ki-duotone ki-time fs-2tx text-warning me-4"><span class="path1"></span><span
                            class="path2"></span></i>
                    <div class="d-flex flex-stack flex-grow-1">
                        <div class="fw-semibold">
                            <h4 class="text-gray-900 fw-bold">Pengajuan Nonaktifkan Akun Sedang Diproses</h4>
                            <div class="fs-6 text-gray-700">
                                Anda telah mengajukan penonaktifan akun ke Admin. Pengajuan Anda saat ini sedang
                                menunggu persetujuan dan tindakan verifikasi oleh Administrator.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-warning fw-semibold" id="btn_cancel_deactivate_request"
                        action-url="{{ route('profil-pengguna.keamanan.cancel-deactivate') }}">
                        <span class="indicator-label"><i class="ki-duotone ki-cross-circle fs-2 me-1"><span
                                    class="path1"></span><span class="path2"></span></i> Batalkan Pengajuan
                            Nonaktifkan Akun</span>
            ...
            @else
                ...
                <div class="notice d-flex bg-light-danger rounded border-danger border border-dashed mb-9 p-6">
                    <i class="ki-duotone ki-information-5 fs-2tx text-danger me-4"><span class="path1"></span><span
                            class="path2"></span><span class="path3"></span></i>
                    <div class="d-flex flex-stack flex-grow-1">
                        <div class="fw-semibold">
                            <h4 class="text-gray-900 fw-bold">Anda Ingin Menonaktifkan Akun Ini?</h4>
                            <div class="fs-6 text-gray-700">
                                Pengajuan penonaktifan akun akan dikirimkan ke Admin untuk diproses. Setelah disetujui
                                oleh Admin, akun Anda akan dinonaktifkan dan Anda tidak dapat login kembali.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-danger fw-semibold" data-bs-toggle="modal"
                        data-bs-target="#modal_confirm_deactivate_account">
                        <i class="ki-duotone ki-cross-circle fs-2 me-1"><span class="path1"></span><span
                                class="path2"></span></i> Ajukan Nonaktifkan Akun
                    </button>
                </div>
            @endif
        </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal"
                        data-bs-toggle="tooltip" data-bs-placement="top" title="Tutup Modal">
                        <i class="ki-duotone ki-cross fs-1"><span class="path1"></span><span class="path2"></span></i>
                    </div>
                </div>
                <form id="form_profil_keamanan_deactivate" action="{{ route('profil-pengguna.keamanan.deactivate') }}"
                    method="POST">
                    @csrf
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        <div class="text-center mb-9">
                            <div class="symbol symbol-75px symbol-circle mb-5 bg-light-danger">
                                <span class="symbol-label">
                                    <i class="ki-duotone ki-shield-cross fs-3x text-danger"><span
                            ...
                            <div class="text-gray-500 fw-semibold fs-6">
                                Demi keamanan, silakan masukkan password akun Anda untuk mengonfirmasi pengajuan ini ke
                                Admin.
                            </div>
                        </div>
                        ...
                        <div class="mb-6 fv-row">
                            ...
                            <div class="input-group input-group-solid input-group-lg">
                                <input type="password" name="password" id="input_deactivate_password"
                                    class="form-control form-control-lg form-control-solid"
                                    placeholder="Masukkan password akun Anda" required />
                                <span class="input-group-text cursor-pointer btn-toggle-deactivate-password"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Tampilkan / Sembunyikan Password">
                                    <i class="ki-duotone ki-eye fs-2 toggle-icon"><span class="path1"></span><span
                                            class="path2"></span><span class="path3"></span></i>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer flex-center">
                        ...
                        <button type="submit" class="btn btn-danger" id="btn_confirm_deactivate">
                            <span class="indicator-label"><i class="ki-duotone ki-paper-plane fs-2 me-1"><span
                                        class="path1"></span><span class="path2"></span></i> Kirim Pengajuan Ke
                                Admin</span>
                            <span class="indicator-progress">Memproses... <span
                                    class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                        </button>
                    ...
                    .then(async (response) => {
                        ...
                        if (response.ok && data.success) {
                            const modalEl = document.getElementById(
                                'modal_confirm_deactivate_account');
                            if (modalEl && typeof bootstrap !== 'undefined' && bootstrap
                                .Modal) {
                            ...
                            if (typeof SwalHelper !== 'undefined' && SwalHelper.success) {
                                SwalHelper.success(data.message ||
                                    'Pengajuan nonaktifkan akun berhasil dikirim ke Admin.');
                            ...
                            if (typeof SwalHelper !== 'undefined' && SwalHelper
                                .validationError) {
                                SwalHelper.validationError({
                                    responseJSON: data
                                });
                            } else {
                                let errors = data.errors ? Object.values(data.errors).flat()
                                    .join('<br>') : (data.message || 'Validasi gagal.');
                ...
                fetch(actionUrl, {
                    ...
                    .then(async (response) => {
                        ...
                        if (response.ok && data.success) {
                            if (typeof SwalHelper !== 'undefined' && SwalHelper.success) {
                                SwalHelper.success(data.message ||
                                    'Pengajuan nonaktifkan akun telah dibatalkan.');
                            } else if (typeof Swal !== 'undefined') {
                                Swal.fire({
                                    text: data.message,
                                    icon: 'success',
