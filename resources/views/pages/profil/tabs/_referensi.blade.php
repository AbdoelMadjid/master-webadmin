    ...
    <div class="card-header card-header-stretch">
        ...
        <div class="card-toolbar">
            ...
            <ul class="nav nav-stretch fs-5 fw-semibold nav-line-tabs border-transparent" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a id="kt_referrals_tab_2" class="nav-link text-active-gray-800 me-4" data-bs-toggle="tab"
                        role="tab" href="#kt_referrals_2">2022</a>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <table class="table table-row-bordered align-middle gy-6">
                    ...
                    <tbody class="fs-6 fw-semibold text-gray-600">
                        <tr>
                            ...
                            <td class="ps-0">
                                <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Marcus
                                    Harris</a>
                            </td>
                            <td>Nov 24, 2020</td>
                            <td>26%</td>
                        ...
                        <tr>
                            ...
                            <td class="ps-0">
                                <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Williams
                                    Brown</a>
                            </td>
                            <td>Apr 30, 2020</td>
                            <td>43%</td>
