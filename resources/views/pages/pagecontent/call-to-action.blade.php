            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-6 bg-white p-5 rounded border border-gray-200 shadow-xs">
                ...
                <div class="d-flex align-items-center gap-2">
                    <span data-bs-toggle="tooltip" data-bs-placement="top" title="{{ app()->getLocale() == 'en' ? 'Operational Guide' : 'Petunjuk Operasional' }}">
                        <button type="button" class="btn btn-icon btn-danger shadow-xs" data-bs-toggle="modal" data-bs-target="#kt_modal_cta_help">
            ...
            <div class="card border border-gray-200">
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex align-items-center gap-3 bg-light-primary p-3 rounded border border-primary-subtle">
                            ...
                            <div class="form-check form-switch form-check-custom form-check-solid">
                                <input class="form-check-input h-20px w-35px cursor-pointer" type="checkbox" id="cta_is_active" 
                                       {{ $cta->is_active ? 'checked' : '' }} onchange="toggleCtaStatus()">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form id="kt_cta_settings_form" class="form" action="#" method="POST">
                        ...
                        <div class="row g-9 mb-8">
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" name="title" id="title" 
                                       value="{{ old('title', $cta->title) }}" placeholder="e.g. Bergabunglah dengan Universitas Kami" required />
                            </div>
                            <div class="col-md-6 fv-row">
                        ...
                        <div class="row g-9 mb-6">
                            <div class="col-md-4 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" name="primary_button_text" id="primary_button_text" 
                                       value="{{ old('primary_button_text', $cta->primary_button_text) }}" placeholder="e.g. Daftar Sekarang" />
                            </div>
                            <div class="col-md-4 fv-row">
                                <label class="fs-6 fw-semibold mb-2">
                                    <span>{{ app()->getLocale() == 'en' ? 'Primary Button Text (EN)' : 'Teks Tombol Utama (EN)' }}</span>
                                </label>
                                <input type="text" class="form-control form-control-solid" name="primary_button_text_en" id="primary_button_text_en" 
                                       value="{{ old('primary_button_text_en', $cta->primary_button_text_en) }}" placeholder="e.g. Apply Now" />
                            </div>
                            <div class="col-md-4 fv-row">
                                <label class="fs-6 fw-semibold mb-2">
                                    <span>{{ app()->getLocale() == 'en' ? 'Target URL' : 'URL Target Link' }}</span>
                                </label>
                                <input type="text" class="form-control form-control-solid" name="primary_button_url" id="primary_button_url" 
                                       value="{{ old('primary_button_url', $cta->primary_button_url) }}" placeholder="e.g. website/apply-for-all-intake" />
                            </div>
                        </div>
                        ...
                        <div class="row g-9 mb-8">
                            <div class="col-md-4 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid" name="secondary_button_text" id="secondary_button_text" 
                                       value="{{ old('secondary_button_text', $cta->secondary_button_text) }}" placeholder="e.g. Hubungi Kami" />
                            </div>
                            <div class="col-md-4 fv-row">
                                <label class="fs-6 fw-semibold mb-2">
                                    <span>{{ app()->getLocale() == 'en' ? 'Secondary Button Text (EN)' : 'Teks Tombol Sekunder (EN)' }}</span>
                                </label>
                                <input type="text" class="form-control form-control-solid" name="secondary_button_text_en" id="secondary_button_text_en" 
                                       value="{{ old('secondary_button_text_en', $cta->secondary_button_text_en) }}" placeholder="e.g. Contact Us" />
                            </div>
                            <div class="col-md-4 fv-row">
                                <label class="fs-6 fw-semibold mb-2">
                                    <span>{{ app()->getLocale() == 'en' ? 'Target URL' : 'URL Target Link' }}</span>
                                </label>
                                <input type="text" class="form-control form-control-solid" name="secondary_button_url" id="secondary_button_url" 
                                       value="{{ old('secondary_button_url', $cta->secondary_button_url) }}" placeholder="e.g. website/contacts" />
                            </div>
                        </div>
