                                ...
                                <div class="row g-7 h-250px h-md-375px">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <a class="d-block card-rounded overlay h-100" data-fslightbox="lightbox-projects"
                                            ...
                                            <!--begin::Image-->
                                            <div
                                                class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-100"style="background-image: url('assets/media/stock/600x600/img-23.jpg');">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                        ...
                                        <div class="row g-7 h-250px h-md-375px">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <a class="d-block card-rounded overlay h-100"
                                                    ...
                                                    <!--begin::Image-->
                                                    <div
                                                        class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-100"style="background-image: url('assets/media/stock/600x400/img-79.jpg');">
                                                    </div>
                                                    <!--end::Image-->
                                                    <!--begin::Action-->
                                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3 g-lg-6">
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="javascript:void(0)">
                                                <img src="assets/media/stock/600x600/img-14.jpg" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="javascript:void(0)">
                                                <img src="assets/media/stock/600x600/img-10.jpg" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="javascript:void(0)">
                                                <img src="assets/media/stock/600x600/img-18.jpg" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="javascript:void(0)">
                                                <img src="assets/media/stock/600x600/img-30.jpg" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="javascript:void(0)">
                                                <img src="assets/media/stock/600x600/img-31.jpg" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/custom/pages/social/feeds.js') }}"></script>
