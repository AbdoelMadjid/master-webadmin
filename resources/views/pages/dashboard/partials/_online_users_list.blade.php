    ...
    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
        <div class="d-flex align-items-center p-3 rounded bg-light border border-gray-200 h-100">
            ...
            <div class="d-flex flex-column overflow-hidden me-2">
                <a href="{{ url('profil-pengguna') }}"
                    class="text-gray-900 fw-bold text-hover-primary text-truncate fs-6 mb-0">
                    {{ $user->name }}
                    @if ($user->id === auth()->id())
                ...
                <span class="text-muted fs-7 text-truncate" title="Durasi sejak login">
                    <i class="ki-duotone ki-time fs-8 text-success me-1"><span class="path1"></span><span
                            class="path2"></span></i>
                    Login
                    {{ $loginTime ? \Illuminate\Support\Carbon::parse($loginTime)->diffForHumans() : 'baru saja' }}
                </span>
            </div>
            <!--end::User Info-->
        </div>
...
@empty
    <div class="col-12">
        <div class="text-center py-4 text-muted">
            <i class="ki-duotone ki-information-2 fs-2x text-muted mb-2"><span class="path1"></span><span
