                                        ...
                                        <div class="">
                                            ...
                                            <span class="fw-semibold text-muted me-6">Product:
                                                <a href="javascript:void(0)"
                                                    class="text-muted text-hover-primary">Metronic</a></span>
                                            <!--end::Label-->
                                            <!--begin::Label-->
                        ...
                        <div class="flex-column flex-lg-row-auto w-100 mw-lg-300px mw-xxl-350px">
                            ...
                            <div class="card-rounded bg-primary bg-opacity-5 p-10 mb-15">
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--begin::Subtitle-->
                                    <a href="javascript:void(0)"
                                        class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">React
                                        Admin</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--begin::Subtitle-->
                                    <a href="javascript:void(0)"
                                        class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Vue
                                        Dashboard</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--begin::Subtitle-->
                                    <a href="javascript:void(0)"
                                        class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Niche
                                        Theme</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--begin::Subtitle-->
                                    <a href="javascript:void(0)"
                                        class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Dorsey
                                        Front-end</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--begin::Subtitle-->
                                    <a href="javascript:void(0)"
                                        class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">CRM
                                        Admin</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--begin::Subtitle-->
                                    <a href="javascript:void(0)"
                                        class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Admin
                                        Dashbaord</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
