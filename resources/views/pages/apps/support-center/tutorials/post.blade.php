                        ...
                        <div class="flex-lg-row-fluid me-xl-15">
                            ...
                            <div class="mb-17">
                                ...
                                <div class="mb-8">
                                    ...
                                    <!--end::Info-->
                                    <!--begin::Title-->
                                    <a href="javascript:void(0)" class="text-gray-900 text-hover-primary fs-2 fw-bold">Admin
                                        Panel -
                                        How To Get
                                        Started Tutorial.
                                    ...
                                    <div class="overlay mt-8">
                                        ...
                                        <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-350px"
                                            style="
                                    background-image: url('assets/media/stock/1600x800/img-1.jpg');
                                  ">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Links-->
                                ...
                                <div class="d-flex flex-center">
                                    ...
                                    <!--begin::Icon-->
                                    <a href="javascript:void(0)" class="mx-4">
                                        <img src="assets/media/svg/brand-logos/instagram-2-1.svg" class="h-20px my-2"
                                            alt="" />
                                    </a>
                                    <!--end::Icon-->
                                    <!--begin::Icon-->
                        ...
                        <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                            ...
                            <div class="mb-16">
                                ...
                                <div class="d-flex flex-stack fw-semibold fs-5 text-muted mb-4">
                                    <!--begin::Text-->
                                    <a href="javascript:void(0)" class="text-muted text-hover-primary pe-2">SaaS
                                        Solutions</a>
                                    <!--end::Text-->
                                    <!--begin::Number-->
                                ...
                                <div class="d-flex flex-stack fw-semibold fs-5 text-muted mb-4">
                                    <!--begin::Text-->
                                    <a href="javascript:void(0)" class="text-muted text-hover-primary pe-2">Company
                                        News</a>
                                    <!--end::Text-->
                                    <!--begin::Number-->
                                ...
                                <div class="d-flex flex-stack fw-semibold fs-5 text-muted mb-4">
                                    <!--begin::Text-->
                                    <a href="javascript:void(0)" class="text-muted text-hover-primary pe-2">Events &
                                        Activities</a>
                                    <!--end::Text-->
                                    <!--begin::Number-->
                                ...
                                <div class="d-flex flex-stack fw-semibold fs-5 text-muted mb-4">
                                    <!--begin::Text-->
                                    <a href="javascript:void(0)" class="text-muted text-hover-primary pe-2">Support
                                        Related</a>
                                    <!--end::Text-->
                                    <!--begin::Number-->
                                ...
                                <div class="d-flex flex-stack fw-semibold fs-5 text-muted">
                                    <!--begin::Text-->
                                    <a href="javascript:void(0)" class="text-muted text-hover-primary pe-2">Product
                                        Updates</a>
                                    <!--end::Text-->
                                    <!--begin::Number-->
                            ...
                            <div class="m-0">
                                ...
                                <div class="d-flex flex-stack mb-7">
                                  ...
                                  ">
                                    ...
                                    <div class="m-0">
                                        <a href="javascript:void(0)"
                                            class="text-gray-900 fw-bold text-hover-primary fs-6">About
                                            Bootstrap
                                            Admin</a>
                                ...
                                <div class="d-flex flex-stack mb-7">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="
                                    background-image: url('assets/media/stock/600x400/img-2.jpg');
                                  ">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    ...
                                    <div class="m-0">
                                        <a href="javascript:void(0)"
                                            class="text-gray-900 fw-bold text-hover-primary fs-6">A yellow
                                            sofa</a>
                                        <span class="text-gray-600 fw-semibold d-block pt-1 fs-7">We’ve been a focused on
                                            making a
                                            the
                                ...
                                <div class="d-flex flex-stack mb-7">
                                  ...
                                  ">
                                    ...
                                    <div class="m-0">
                                        <a href="javascript:void(0)"
                                            class="text-gray-900 fw-bold text-hover-primary fs-6">Our Camra
                                            Mega Set</a>
                                        <span class="text-gray-600 fw-semibold d-block pt-1 fs-7">We’ve been a focused on
                                            making a
                                            the
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="
                                    background-image: url('assets/media/stock/600x400/img-4.jpg');
                                  ">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    ...
                                    <div class="m-0">
                                        <a href="javascript:void(0)"
                                            class="text-gray-900 fw-bold text-hover-primary fs-6">Time to
                                            cook and
                                            eat?</a>
                                        <span class="text-gray-600 fw-semibold d-block pt-1 fs-7">We’ve been a focused on
                                            making a
                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch me-md-6">
                                    ...
                                    <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                                        style="
                                  background-image: url('assets/media/stock/600x400/img-73.jpg');
                                "
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch mx-md-3">
                                    ...
                                    <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                                        style="
                                  background-image: url('assets/media/stock/600x400/img-74.jpg');
                                "
                                        data-fslightbox="lightbox-video-tutorials"
                                        href="https://www.youtube.com/embed/btornGtLwIo">
                                        <img src="assets/media/svg/misc/video-play.svg"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch ms-md-6">
                                    ...
                                    <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                                        style="
                                  background-image: url('assets/media/stock/600x400/img-47.jpg');
                                "
                                        data-fslightbox="lightbox-video-tutorials"
                                ...
                                <div class="card-xl-stretch me-md-6">
                                    ...
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        ...
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                            style="
                                    background-image: url('assets/media/stock/600x400/img-23.jpg');
                                  ">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch ms-md-6">
                                    ...
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        ...
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                            style="
                                    background-image: url('assets/media/stock/600x400/img-71.jpg');
                                  ">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
