                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-center flex-column py-5">
                                ...
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <a href="javascript:void(0)" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">Emma
                                    Smith</a>
                                <!--end::Name-->
                                <!--begin::Position-->
                                <div class="mb-9">
                            ...
                            <div class="card card-flush mb-6 mb-xl-9">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center position-relative mb-7">
                                        ...
                                        <div class="fw-semibold ms-5">
                                            <a href="javascript:void(0)"
                                                class="fs-5 fw-bold text-gray-900 text-hover-primary">9
                                                Degree Project
                                                Estimation</a>
                                            <!--begin::Info-->
                                            <div class="fs-7 text-muted">
                                    ...
                                    <div class="d-flex align-items-center position-relative">
                                        ...
                                        <div class="fw-semibold ms-5">
                                            <a href="javascript:void(0)"
                                                class="fs-5 fw-bold text-gray-900 text-hover-primary">Mivy
                                                App R&D, Meeting
                                                with clients</a>
                                            <!--begin::Info-->
                                            <div class="fs-7 text-muted">
                            ...
                            <div class="card pt-4 mb-6 mb-xl-9">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-6 w-200px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="javascript:void(0)" class="menu-link px-3"
                                                    data-bs-toggle="modal" data-bs-target="#kt_modal_add_auth_app">Use
                                                    authenticator app</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                ...
                                <div class="card-body pb-5">
                                    ...
                                    <div class="text-gray-600">
                                        ...
                                        you can
                                        <a href="javascript:void(0)" class="me-1">generate a backup code</a>to sign in
                                        to your
                                        account.
                                    </div>
                                    <!--end::Disclaimer-->
