                        ...
                        <div class="col-md-4 col-lg-12 col-xl-4">
                            ...
                            <div class="card mb-6 mb-xl-9">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-2">
                                        <a href="javascript:void(0)"
                                            class="fs-4 fw-bold mb-1 text-gray-900 text-hover-primary">User
                                            Module
                                            Testing</a>
                                    </div>
                                    <!--end::Title-->
                            ...
                            <!--end::Card-->
                            <a href="javascript:void(0)" class="btn btn-primary er w-100 fs-6 px-8 py-4"
                                data-bs-toggle="modal" data-bs-target="#kt_modal_new_target">Create New Target</a>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-4 col-lg-12 col-xl-4">
                            ...
                            <div class="card mb-6 mb-xl-9">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-2">
                                        <a href="javascript:void(0)"
                                            class="fs-4 fw-bold mb-1 text-gray-900 text-hover-primary">Sales
                                            report
                                            page</a>
                                    </div>
                                    <!--end::Title-->
                        ...
                        <div class="col-md-4 col-lg-12 col-xl-4">
                            ...
                            <div class="card mb-6 mb-xl-9">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-2">
                                        <a href="javascript:void(0)"
                                            class="fs-4 fw-bold mb-1 text-gray-900 text-hover-primary">To
                                            check User
                                            Management</a>
                                    </div>
                                    <!--end::Title-->
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="javascript:void(0)" class="menu-link px-3">Generate
                                                        Bill</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                            ...
                            <table id="kt_profile_overview_table"
                                ...
                                <tbody class="fs-6">
                                    <tr>
                                        <td class="fw-bold">
                                            <a href="javascript:void(0)"
                                                class="text-gray-900 text-hover-primary">Meeting with
                                                customer</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="fw-bold">
                                            <a href="javascript:void(0)" class="text-gray-900 text-hover-primary">User
                                                Module
                                                Testing</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="fw-bold">
                                            <a href="javascript:void(0)" class="text-gray-900 text-hover-primary">Sales
                                                report
                                                page</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="fw-bold">
                                            <a href="javascript:void(0)" class="text-gray-900 text-hover-primary">Design
                                                main
                                                Dashboard</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="fw-bold">
                                            <a href="javascript:void(0)" class="text-gray-900 text-hover-primary">To
                                                check User
                                                Management</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="fw-bold">
                                            <a href="javascript:void(0)" class="text-gray-900 text-hover-primary">Create
                                                Roles
                                                Module</a>
                                        </td>
                                        <td>
