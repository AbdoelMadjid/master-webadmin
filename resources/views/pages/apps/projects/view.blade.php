                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    ...
                                    <div class="fw-semibold">
                                        <div class="fs-6 text-gray-700">
                                            <a href="javascript:void(0)" class="fw-bold me-1">Invite New .NET
                                                Collaborators</a>to
                                            create great
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card card-flush h-lg-100">
                        ...
                        <div class="card-header mt-6">
                            ...
                            <!--begin::Card toolbar-->
                            <div class="card-toolbar">
                                <a href="javascript:void(0)" class="btn btn-bg-light btn-active-color-primary btn-sm">View
                                    All</a>
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                        ...
                        <div class="card-body p-9 pt-3">
                            ...
                            <div class="d-flex flex-column mb-9">
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <!--begin::Details-->
                                    <div class="fw-semibold">
                                        <a class="fs-6 fw-bold text-gray-900 text-hover-primary"
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <div class="fw-semibold">
                                        <a class="fs-6 fw-bold text-gray-900 text-hover-primary"
                                            href="javascript:void(0)">Completed
                                            Project
                                            Stylings</a>
                                        <div class="text-gray-500">
                    ...
                    <div class="card card-flush h-lg-100">
                        ...
                        <div class="card-body d-flex flex-column p-9 pt-3 mb-9">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)"
                                        class="fs-5 fw-bold text-gray-900 text-hover-primary">Melody
                                        Macy</a>
                                    <div class="text-gray-500">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)"
                                        class="fs-5 fw-bold text-gray-900 text-hover-primary">Sean
                                        Bean</a>
                                    <div class="text-gray-500">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)"
                                        class="fs-5 fw-bold text-gray-900 text-hover-primary">Brian
                                        Cox</a>
                                    <div class="text-gray-500">
                    ...
                    <div class="card card-flush h-lg-100">
                        ...
                        <div class="card-body d-flex flex-column mb-9 p-9 pt-3">
                            ...
                            <div class="d-flex align-items-center position-relative mb-7">
                                ...
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)"
                                        class="fs-6 fw-bold text-gray-900 text-hover-primary">Create
                                        FureStibe branding
                                        logo</a>
                                    <!--begin::Info-->
                                    <div class="text-gray-500">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid" multiple="multiple"
                                                    data-kt-select2="true" data-close-on-select="false"
                                                    data-placeholder="Select option"
                                                    data-dropdown-parent="#kt_menu_6606384e059fe" data-allow-clear="true">
                                                    <option></option>
                                                    <option value="1">Approved</option>
                                                    <option value="2">Pending</option>
                                                    <option value="2">In Process</option>
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid" multiple="multiple"
                                                    data-kt-select2="true" data-close-on-select="false"
                                                    data-placeholder="Select option"
                                                    data-dropdown-parent="#kt_menu_6606384e05a12" data-allow-clear="true">
                                                    <option></option>
                                                    <option value="1">Approved</option>
                                                    <option value="2">Pending</option>
                                                    <option value="2">In Process</option>
                            ...
                            <div class="d-flex align-items-center position-relative mb-7">
                                ...
                                <!--begin::Details-->
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)" class="fs-6 fw-bold text-gray-900 text-hover-primary">9
                                        Degree
                                        Porject
                                        Estimation</a>
                                    <!--begin::Info-->
                            ...
                            <div class="d-flex align-items-center position-relative mb-7">
                                ...
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)"
                                        class="fs-6 fw-bold text-gray-900 text-hover-primary">Dashgboard
                                        UI & UX for
                                        Leafr CRM</a>
                                    <!--begin::Info-->
                                    <div class="text-gray-500">
                            ...
                            <div class="d-flex align-items-center position-relative">
                                ...
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)"
                                        class="fs-6 fw-bold text-gray-900 text-hover-primary">Mivy App
                                        R&D, Meeting with
                                        clients</a>
                                    <!--begin::Info-->
                                    <div class="text-gray-500">
