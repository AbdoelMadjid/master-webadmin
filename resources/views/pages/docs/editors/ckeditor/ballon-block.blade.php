                    ...
                    <div class="pt-10">
                        ...
                        <div class="pt-5">
                            <div id="kt_docs_ckeditor_balloon_block">
                                ...
                                <figure class="image"><img src="assets/media/stock/600x400/img-1.jpg"
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/custom/documentation/editors/ckeditor/balloon-block.js') }}"></script>
