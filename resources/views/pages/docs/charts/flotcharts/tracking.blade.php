...
@section('scripts')
    ...
    <script src="{{ asset('assets/plugins/custom/flotcharts/flotcharts.bundle.js') }}"></script>
    <!--end::Vendors Javascript-->

    <!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('assets/js/custom/documentation/charts/flotcharts/tracking.js') }}"></script>
