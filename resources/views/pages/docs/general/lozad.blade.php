                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-center h-300px">
                                            <img src="assets/media/misc/spinner.gif"
                                                data-src="assets/media/stock/600x400/img-1.jpg" class="lozad rounded mw-100"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!--end::Col-->
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-center h-300px">
                                            <img src="assets/media/misc/spinner.gif"
                                                data-src="assets/media/stock/600x400/img-2.jpg" class="lozad rounded mw-100"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!--end::Col-->
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-flex flex-center h-300px">
                                            <img src="assets/media/misc/spinner.gif"
                                                data-src="assets/media/stock/600x400/img-3.jpg" class="lozad rounded mw-100"
                                                alt="" />
                                        </div>
                                    </div>
                                    <!--end::Col-->
