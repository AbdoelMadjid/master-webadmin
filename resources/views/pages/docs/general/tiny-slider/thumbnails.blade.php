                                ...
                                <div class="tns tns-default mb-3" style="direction: ltr">
                                    ...
                                    <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false"
                                        ...
                                        <div class="text-center px-5 py-5">
                                            <img src="assets/media/stock/600x400/img-1.jpg" class="card-rounded mw-100"
                                                alt="" />
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="text-center px-5 py-5">
                                            <img src="assets/media/stock/600x400/img-2.jpg" class="card-rounded mw-100"
                                                alt="" />
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="text-center px-5 py-5">
                                            <img src="assets/media/stock/600x400/img-3.jpg" class="card-rounded mw-100"
                                                alt="" />
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="text-center px-5 py-5">
                                            <img src="assets/media/stock/600x400/img-4.jpg" class="card-rounded mw-100"
                                                alt="" />
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="text-center px-5 py-5">
                                            <img src="assets/media/stock/600x400/img-5.jpg" class="card-rounded mw-100"
                                                alt="" />
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
                                        <div class="text-center px-5 py-5">
                                            <img src="assets/media/stock/600x400/img-6.jpg" class="card-rounded mw-100"
                                                alt="" />
                                        </div>
                                        <!--end::Item-->
                                ...
                                <div class="d-flex flex-center">
                                    <ul class="d-flex align-items-center list-unstyled gap-5 cursor-pointer">
                                        <li class="d-flex gap-3" id="kt_slider_thumbnails">
                                            ...
                                            <img src="assets/media/stock/600x400/img-1.jpg" class="w-50px rounded"
                                                alt="" />

                                            <img src="assets/media/stock/600x400/img-2.jpg" class="w-50px rounded"
                                                alt="" />

                                            <img src="assets/media/stock/600x400/img-3.jpg" class="w-50px rounded"
                                                alt="" />

                                            <img src="assets/media/stock/600x400/img-4.jpg" class="w-50px rounded"
                                                alt="" />

                                            <img src="assets/media/stock/600x400/img-5.jpg" class="w-50px rounded"
                                                alt="" />

                                            <img src="assets/media/stock/600x400/img-6.jpg" class="w-50px rounded"
                                                alt="" />
