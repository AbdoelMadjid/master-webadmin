        ...
        <div class="modal-content">
            ...
            <form id="kt_modal_import_user_form" class="form" action="#" enctype="multipart/form-data">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <div class="d-flex flex-stack flex-grow-1">
                            <div class="fw-semibold">
                                ...
                                <div class="fs-7 text-gray-700">
                                    Unduh berkas <strong>Master Format Excel</strong> terlebih dahulu, isi data pengguna
                                    sesuai kolom yang disediakan, lalu unggah kembali berkas tersebut.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="d-flex align-items-center justify-content-between mb-5 p-3 rounded bg-light-info border border-info border-dashed">
                        <div>
                        ...
                        <a href="{{ route('manajemenpengguna.users.template') }}" class="btn btn-sm btn-info"
                            id="btn_download_template_modal">
                            <i class="ki-duotone ki-file-down fs-4 me-1"><span class="path1"></span><span
                                    class="path2"></span></i> Download Template
                        </a>
                    </div>

                    <div class="fv-row mb-7">
                        <label class="required fw-semibold fs-6 mb-2">Pilih Berkas Excel / CSV</label>
                        <input type="file" name="excel_file" id="excel_file" class="form-control form-control-solid"
                            accept=".xlsx, .xls, .csv" required />
                        <div class="form-text">Format yang didukung: <code>.xlsx</code>, <code>.xls</code>,
                            <code>.csv</code> (Maksimal 5MB).</div>
                    </div>
                </div>
                ...
                <div class="modal-footer flex-center">
                    ...
                    <button type="submit" class="btn btn-success" id="btn_submit_import_user">
                        <i class="ki-duotone ki-file-up fs-2 me-1"><span class="path1"></span><span
                                class="path2"></span></i> Proses Upload Massal
                    </button>
                </div>
            </form>
        </div>
