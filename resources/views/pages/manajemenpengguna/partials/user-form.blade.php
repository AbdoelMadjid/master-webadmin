                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <div class="fv-row mb-7 text-center">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true">
                            <div class="image-input-wrapper w-125px h-125px" id="user_avatar_preview"
                                style="background-image: url('{{ asset('assets/media/svg/avatars/default-avatar.svg') }}')">
                            </div>
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <input type="text" name="name" id="user_name"
                            class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Nama lengkap user"
                            required />
                    </div>
                    <div class="fv-row mb-7">
                        <label class="required fw-semibold fs-6 mb-2">Alamat Email</label>
                        <input type="email" name="email" id="user_email"
                            class="form-control form-control-solid mb-3 mb-lg-0" placeholder="nama@domain.com"
                            required />
                    </div>
                    <div class="fv-row mb-7">
                        <label class="fw-semibold fs-6 mb-2" id="label_user_password">Kata Sandi</label>
                        <input type="password" name="password" id="user_password"
                            class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Minimal 8 karakter" />
                        <span class="fs-7 text-muted" id="user_password_help">Biarkan kosong jika tidak ingin mengubah
                            kata sandi.</span>
                    </div>
                    <div class="fv-row">
                        <label
                            class="fs-6 fw-semibold mb-2 text-gray-800 d-flex align-items-center justify-content-between">
                            ...
                            @foreach ($roles as $role)
                                ...
                                <div class="col-6 col-sm-4 col-md-3">
                                    <label
                                        ...
                                        <input class="form-check-input user-role-checkbox h-20px w-20px flex-shrink-0"
