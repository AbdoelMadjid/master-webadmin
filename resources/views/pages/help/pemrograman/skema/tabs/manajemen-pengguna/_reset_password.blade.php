...
<div class="schema-grid">
    ...
    <div class="schema-col-6">
        <div class="schema-card">
            <h4><i class="ki-duotone ki-data fs-2 text-primary me-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span><span class="path5"></span></i> Model & Migration Structure</h4>
...
Schema::create('password_reset_requests', function (Blueprint $table) {
    ...
    $table->timestamps();
            ...
            <div class="schema-note mt-3">
                Field <code>is_read</code> controls the <strong>Red Badge Counter</strong> on the header bell icon and notification item inside the <strong>Alerts</strong> tab.
            </div>
        </div>
    </div>
...
return back()->with('status', 'Password reset request has been successfully sent to Master/Admin.');</code></pre>
            <div class="schema-note mt-3">
                Verifies email existence before creating a pending request record in database.
            </div>
        </div>
    </div>
...
Route::prefix('manajemenpengguna')->name('manajemenpengguna.')->group(function () {
    ...
    Route::post('reset-password/{id}/reject', [PasswordResetRequestController::class, 'reject'])->name('reset-password.reject');
            ...
            <div class="schema-note mt-3">
                Method <code>markAsRead($id)</code> changes <code>is_read = true</code> when notification is clicked, then redirects Admin to management page.
            </div>
        </div>
    </div>
...
$resetReq->update(['status' => 'completed', 'is_read' => true, 'handled_by' => Auth::id()]);</code></pre>
            <div class="schema-note mt-3">
                Password reset modal is pre-filled with default password <code>Password!12345</code> for Admin operational convenience.
            </div>
        </div>
    </div>

    <!--====================================================-->
    <!-- 5. RECAPITULATION OF RESET PASSWORD FILES -->
    <!--====================================================-->
                ...
                <table class="table table-row-dashed align-middle gy-3 fs-7 mb-0">
                    <thead>
                        <tr class="fw-bold text-gray-700 bg-light">
                            ...
                            <th>File Path / Class</th>
                            <th>Main Role & Function</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td>Creates <code>password_reset_requests</code> table (user_id, email, status, is_read, admin_notes, handled_by, handled_at).</td>
                        </tr>
                        <tr>
                            <td><strong>Eloquent Model</strong></td>
                            <td><code>App\Models\ManajemenPengguna\PasswordResetRequest.php</code></td>
                            <td>Relational model to <code>User</code> (requester) and <code>handler</code> (responsible admin).</td>
                        </tr>
                        <tr>
                            <td><strong>Public Controller</strong></td>
                            <td><code>App\Http\Controllers\Auth\PasswordResetLinkController.php</code></td>
                            <td>Registered email validation & creation of pending <code>PasswordResetRequest</code> records.</td>
                        </tr>
                        <tr>
                            ...
                            <td>Data rendering, password reset execution, request rejection, and <code>markAsRead</code> dispatch.</td>
                        </tr>
                        <tr>
                            <td><strong>View & Modal Form</strong></td>
                            <td><code>resources/views/pages/manajemenpengguna/reset-password.blade.php</code></td>
                            <td>Responsive DataTables display, client-side JS search, and default password set modal <code>Password!12345</code>.</td>
                        </tr>
                        <tr>
                            ...
                            <td>Renders red badge counter on topbar bell icon and registers notification items under <strong>Alerts</strong> tab.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
