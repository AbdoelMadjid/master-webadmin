...
<div class="schema-grid">
    <!--====================================================-->
    <!-- 1. SPATIE ROLE MODEL & ARCHITECTURE -->
    <!--====================================================-->
...
$roles = Role::withCount(['users', 'permissions'])
            ...
            <div class="schema-note mt-3">
                Each Role is automatically connected to the `permissions` table via the `role_has_permissions` pivot table.
            </div>
        </div>
    </div>
        ...
        <div class="schema-card">
            ...
            <div class="schema-flow">
                <div class="schema-step">
                    ...
                    <code>RoleController@index</code> -> Displays the list of roles, role summary cards, and permission matrix data for modals.
                </div>
                <div class="schema-step">
                    <strong><code>POST /manajemenpengguna/roles</code></strong><br>
                    <code>RoleController@store</code> -> Validates via <code>RoleRequest</code>, creates a new Role, and syncs permissions via <code>$role->syncPermissions()</code>.
                </div>
                <div class="schema-step">
                    <strong><code>PUT /manajemenpengguna/roles/{id}</code></strong><br>
                    <code>RoleController@update</code> -> Updates role name and attached permission list.
                </div>
            </div>
        </div>
    </div>
