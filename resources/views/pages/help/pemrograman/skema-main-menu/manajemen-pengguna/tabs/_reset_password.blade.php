...
$resetReq->update(['status' => 'completed', 'is_read' => true, 'handled_by' => Auth::id()]);</code></pre>
    ...
    <div class="schema-col-12 mt-4">
        <div class="schema-card">
            <h4><i class="ki-duotone ki-file-sheet fs-2 text-primary me-2"><span class="path1"></span><span class="path2"></span></i> Password Reset Component & File Recapitulation</h4>
