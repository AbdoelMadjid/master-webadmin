        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="schema-shell">
                ...
                <div class="schema-hero mb-6">
                    <span class="schema-pill">{{ __('help.operasional') }} > {{ __('help.app_support') }}</span>
                    <h2 class="fw-bold">{{ __('help.pages.operasional.app-support.hero_title') }}</h2>
                    <p class="schema-lead">
                        {{ __('help.pages.operasional.app-support.hero_lead') }}
                    </p>
                </div>
                <!--end::Hero-->
