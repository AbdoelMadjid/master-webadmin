        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="schema-shell">
                ...
                <div class="schema-hero mb-6">
                    <span class="schema-pill">Operasional & Technical Guide > App Support</span>
                    <h2 class="fw-bold">Panduan Operasional Fitur App Support</h2>
                    <p class="schema-lead">
                        Dokumentasi teknis dan panduan operasional lengkap untuk seluruh menu di bawah modul App Support, meliputi Menu Dinamis, App Profil, App Fitur (Feature Toggle), Backup DB, dan Data Login.
                    </p>
                </div>
                <!--end::Hero-->
                ...
                @include('pages.help.pemrograman.operasional.tabs.app-support._' . str_replace('-', '_', $activeTab))
