...
<div class="schema-grid">
    ...
    <div class="schema-col-12">
        <div class="ps-4 my-2">
            <h3 class="fw-bold text-gray-900 mb-1">Dynamic Menu Management (Sidebar Menu Management)</h3>
...
<div class="schema-grid">
    ...
    <div class="schema-col-12">
        <div class="ps-4 my-2">
            <h3 class="fw-bold text-gray-900 mb-1">Pengelolaan Menu Dinamis (Sidebar Menu Management)</h3>
