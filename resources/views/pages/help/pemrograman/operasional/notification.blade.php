                            ...
                            <div class="row g-4 mt-1">
                                <div class="col-md-6">
                                    <div class="p-4 rounded bg-light-warning border border-warning border-dashed h-100">
                                        <h5 class="fw-bold text-warning mb-2"><i class="ki-duotone ki-notification-status fs-3 text-warning me-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i>A. Notification Indicators & Triggers</h5>
                                ...
                                <div class="col-md-6">
                                    <div class="p-4 rounded bg-light-success border border-success border-dashed h-100">
                                        <h5 class="fw-bold text-success mb-2"><i class="ki-duotone ki-user-tick fs-3 text-success me-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>B. Admin Handling Actions</h5>
                                        <ul class="schema-list fs-7 mb-0">
                            ...
                            <div class="row g-4 mt-1">
                                <div class="col-md-6">
                                    <div class="p-4 rounded bg-light-danger border border-danger border-dashed h-100">
                                        <h5 class="fw-bold text-danger mb-2"><i class="ki-duotone ki-key fs-3 text-danger me-2"><span class="path1"></span><span class="path2"></span></i>A. Reset Notification Triggers</h5>
                                        <ul class="schema-list fs-7 mb-0">
                                ...
                                <div class="col-md-6">
                                    <div class="p-4 rounded bg-light-primary border border-primary border-dashed h-100">
                                        <h5 class="fw-bold text-primary mb-2"><i class="ki-duotone ki-shield-tick fs-3 text-primary me-2"><span class="path1"></span><span class="path2"></span></i>B. Reset Execution & Badge Clearance</h5>
                                        <ul class="schema-list fs-7 mb-0">
                    ...
                    <div class="schema-col-12 mb-4">
                        <div class="schema-card">
                            ...
                            <div class="row g-4 mt-1">
                                <div class="col-md-6">
                                    <div class="p-4 rounded bg-light-warning border border-warning border-dashed h-100">
                                        <h5 class="fw-bold text-warning mb-2"><i class="ki-duotone ki-notification-status fs-3 text-warning me-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span><span class="path4"></span></i>A. Indikator & Pemicu Notifikasi</h5>
                                        <ul class="schema-list fs-7 mb-0">
                                ...
                                <div class="col-md-6">
                                    <div class="p-4 rounded bg-light-success border border-success border-dashed h-100">
                                        <h5 class="fw-bold text-success mb-2"><i class="ki-duotone ki-user-tick fs-3 text-success me-2"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>B. Tindakan Penanganan Admin</h5>
                                        <ul class="schema-list fs-7 mb-0">
                    ...
                    <div class="schema-col-12 mb-4">
                        <div class="schema-card">
                            ...
                            <div class="row g-4 mt-1">
                                <div class="col-md-6">
                                    <div class="p-4 rounded bg-light-danger border border-danger border-dashed h-100">
                                        <h5 class="fw-bold text-danger mb-2"><i class="ki-duotone ki-key fs-3 text-danger me-2"><span class="path1"></span><span class="path2"></span></i>A. Pemicuan Notifikasi Reset Password</h5>
                                        <ul class="schema-list fs-7 mb-0">
                                ...
                                <div class="col-md-6">
                                    <div class="p-4 rounded bg-light-primary border border-primary border-dashed h-100">
                                        <h5 class="fw-bold text-primary mb-2"><i class="ki-duotone ki-shield-tick fs-3 text-primary me-2"><span class="path1"></span><span class="path2"></span></i>B. Eksekusi Reset & Pembersihan Badge</h5>
                                        <ul class="schema-list fs-7 mb-0">
